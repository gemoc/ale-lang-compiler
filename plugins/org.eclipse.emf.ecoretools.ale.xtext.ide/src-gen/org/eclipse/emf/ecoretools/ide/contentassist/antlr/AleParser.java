...
public class AleParser extends AbstractContentAssistParser {
	...
	public static final class NameMappings {
		...
		private static void init(ImmutableMap.Builder<AbstractElement, String> builder, AleGrammarAccess grammarAccess) {
			...
			builder.put(grammarAccess.getROperationAccess().getAlternatives(), "rule__ROperation__Alternatives");
			builder.put(grammarAccess.getROperationAccess().getAlternatives_0_2(), "rule__ROperation__Alternatives_0_2");
			...
			builder.put(grammarAccess.getROpenClassAccess().getGroup_4(), "rule__ROpenClass__Group_4__0");
			builder.put(grammarAccess.getROpenClassAccess().getGroup_4_2(), "rule__ROpenClass__Group_4_2__0");
			builder.put(grammarAccess.getROpenClassAccess().getGroup_6(), "rule__ROpenClass__Group_6__0");
			builder.put(grammarAccess.getRNewClassAccess().getGroup(), "rule__RNewClass__Group__0");
			builder.put(grammarAccess.getROperationAccess().getGroup_0(), "rule__ROperation__Group_0__0");
			builder.put(grammarAccess.getROperationAccess().getGroup_0_7(), "rule__ROperation__Group_0_7__0");
			builder.put(grammarAccess.getROperationAccess().getGroup_0_7_1(), "rule__ROperation__Group_0_7_1__0");
			builder.put(grammarAccess.getROperationAccess().getGroup_1(), "rule__ROperation__Group_1__0");
			builder.put(grammarAccess.getROperationAccess().getGroup_1_7(), "rule__ROperation__Group_1_7__0");
			builder.put(grammarAccess.getROperationAccess().getGroup_1_7_1(), "rule__ROperation__Group_1_7_1__0");
			...
			builder.put(grammarAccess.getROpenClassAccess().getAbstractAssignment_1(), "rule__ROpenClass__AbstractAssignment_1");
			...
			builder.put(grammarAccess.getROperationAccess().getTagAssignment_0_1(), "rule__ROperation__TagAssignment_0_1");
			builder.put(grammarAccess.getROperationAccess().getDispatchAssignment_0_3(), "rule__ROperation__DispatchAssignment_0_3");
			builder.put(grammarAccess.getROperationAccess().getTypeAssignment_0_4(), "rule__ROperation__TypeAssignment_0_4");
			builder.put(grammarAccess.getROperationAccess().getNameAssignment_0_5(), "rule__ROperation__NameAssignment_0_5");
			builder.put(grammarAccess.getROperationAccess().getParamsAssignment_0_7_0(), "rule__ROperation__ParamsAssignment_0_7_0");
			builder.put(grammarAccess.getROperationAccess().getParamsAssignment_0_7_1_1(), "rule__ROperation__ParamsAssignment_0_7_1_1");
			builder.put(grammarAccess.getROperationAccess().getBodyAssignment_0_9(), "rule__ROperation__BodyAssignment_0_9");
			builder.put(grammarAccess.getROperationAccess().getTagAssignment_1_1(), "rule__ROperation__TagAssignment_1_1");
			builder.put(grammarAccess.getROperationAccess().getTypeAssignment_1_4(), "rule__ROperation__TypeAssignment_1_4");
			builder.put(grammarAccess.getROperationAccess().getNameAssignment_1_5(), "rule__ROperation__NameAssignment_1_5");
			builder.put(grammarAccess.getROperationAccess().getParamsAssignment_1_7_0(), "rule__ROperation__ParamsAssignment_1_7_0");
			builder.put(grammarAccess.getROperationAccess().getParamsAssignment_1_7_1_1(), "rule__ROperation__ParamsAssignment_1_7_1_1");
