...
public class AleParser extends AbstractContentAssistParser {
	...
	public static final class NameMappings {
		...
		private static void init(ImmutableMap.Builder<AbstractElement, String> builder, AleGrammarAccess grammarAccess) {
			...
			builder.put(grammarAccess.getROpenClassAccess().getGroup_5(), "rule__ROpenClass__Group_5__0");
			...
			builder.put(grammarAccess.getROperationAccess().getGroup_6(), "rule__ROperation__Group_6__0");
			builder.put(grammarAccess.getROperationAccess().getGroup_6_1(), "rule__ROperation__Group_6_1__0");
			...
			builder.put(grammarAccess.getROpenClassAccess().getMutablesAssignment_5_1(), "rule__ROpenClass__MutablesAssignment_5_1");
			builder.put(grammarAccess.getROpenClassAccess().getAttributesAssignment_6(), "rule__ROpenClass__AttributesAssignment_6");
			builder.put(grammarAccess.getROpenClassAccess().getOperationsAssignment_7(), "rule__ROpenClass__OperationsAssignment_7");
			...
			builder.put(grammarAccess.getROperationAccess().getDispatchAssignment_2(), "rule__ROperation__DispatchAssignment_2");
			builder.put(grammarAccess.getROperationAccess().getTypeAssignment_3(), "rule__ROperation__TypeAssignment_3");
			builder.put(grammarAccess.getROperationAccess().getNameAssignment_4(), "rule__ROperation__NameAssignment_4");
			builder.put(grammarAccess.getROperationAccess().getParamsAssignment_6_0(), "rule__ROperation__ParamsAssignment_6_0");
			builder.put(grammarAccess.getROperationAccess().getParamsAssignment_6_1_1(), "rule__ROperation__ParamsAssignment_6_1_1");
			builder.put(grammarAccess.getROperationAccess().getBodyAssignment_8(), "rule__ROperation__BodyAssignment_8");
