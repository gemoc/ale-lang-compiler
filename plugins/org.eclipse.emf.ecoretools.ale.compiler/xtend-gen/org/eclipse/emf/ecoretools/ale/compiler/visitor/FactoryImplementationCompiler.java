...
public class FactoryImplementationCompiler {
  ...
  public void compileFactoryImplementation(final EPackage abstractSyntax, final File directory, final String packageRoot) {
    try {
      ...
      MethodSpec.Builder _addParameter = MethodSpec.methodBuilder("create").addAnnotation(Override.class).returns(EObject.class).addParameter(ParameterSpec.builder(EClass.class, "eClass").build());
      ...
      final Function1<EEnum, List<MethodSpec>> _function_1 = (EEnum eEnum_3) -> {
      ...
      final Iterable<MethodSpec> methodsFromString = Iterables.<MethodSpec>concat(IterableExtensions.<EEnum, List<MethodSpec>>map(allEnum, _function_1));
      final Function1<EClass, Boolean> _function_2 = (EClass it) -> {
        boolean _isAbstract = it.isAbstract();
        return Boolean.valueOf((!_isAbstract));
      };
      final Function1<EClass, MethodSpec> _function_3 = (EClass eClass_1) -> {
        MethodSpec _xblockexpression = null;
        {
          ...
          if (((eClass_1.getInstanceClass() != null) && Objects.equal(eClass_1.getInstanceClass(), Map.Entry.class))) {
            ParameterizedTypeName _xblockexpression_1 = null;
            {
              ...
              final EStructuralFeature key = IterableExtensions.<EStructuralFeature>head(IterableExtensions.<EStructuralFeature>filter(Iterables.<EStructuralFeature>filter(eClass_1.eContents(), EStructuralFeature.class), _function_4));
              ...
              final EStructuralFeature value = IterableExtensions.<EStructuralFeature>head(IterableExtensions.<EStructuralFeature>filter(Iterables.<EStructuralFeature>filter(eClass_1.eContents(), EStructuralFeature.class), _function_5));
              _xblockexpression_1 = ParameterizedTypeName.get(ClassName.get(Map.Entry.class), this._visitorCompilerUtils.scopedInterfaceTypeRef(key.getEType(), packageRoot), 
          ...
          MethodSpec.Builder _returns_1 = MethodSpec.methodBuilder(_builder_7.toString()).returns(returnType);
          StringConcatenation _builder_8 = new StringConcatenation();
      ...
      final Iterable<MethodSpec> createMethods = IterableExtensions.<EClass, MethodSpec>map(IterableExtensions.<EClass>filter(allClasses, _function_2), _function_3);
      StringConcatenation _builder_7 = new StringConcatenation();
