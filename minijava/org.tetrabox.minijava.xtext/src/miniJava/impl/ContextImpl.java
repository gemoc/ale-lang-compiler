...
public class ContextImpl extends MinimalEObjectImpl.Container implements Context {
	...
	public EList<Map.Entry<Symbol, SymbolBinding>> getCache() {
		if (cache == null) {
			cache = new EObjectResolvingEList<Map.Entry<Symbol, SymbolBinding>>(Entry.class, this,
					MiniJavaPackage.CONTEXT__CACHE);
		}
		return cache;
	}
	...
	public NotificationChain eInverseAdd(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		...
		case MiniJavaPackage.CONTEXT__CHILD_CONTEXT:
			if (childContext != null)
				msgs = ((InternalEObject) childContext).eInverseRemove(this,
						EOPPOSITE_FEATURE_BASE - MiniJavaPackage.CONTEXT__CHILD_CONTEXT, null, msgs);
	...
	public NotificationChain eBasicRemoveFromContainerFeature(NotificationChain msgs) {
		...
		case MiniJavaPackage.CONTEXT__PARENT_CONTEXT:
			return eInternalContainer().eInverseRemove(this, MiniJavaPackage.CONTEXT__CHILD_CONTEXT, Context.class,
					msgs);
		}
