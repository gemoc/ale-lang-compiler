...
public class ArithOpRemainderImpl extends ArithOpImpl implements ArithOpRemainder {
  @CompilationFinal
  private ArithOpRemainderDispatchWrapperEval cachedEval;

  private ExprDispatchEval dispatchExprEval;

  protected ArithOpRemainderImpl() {
    super();
    this.cachedEval = new boa.interpreter.boa.impl.ArithOpRemainderDispatchWrapperEval(this);
    ...
    boa.interpreter.boa.EvalRes vlhs = ((boa.interpreter.boa.EvalRes)dispatchExprEval.executeDispatch(this.lhs.getCachedEval(), new Object[] {ctx}));
        ...
        if(vlhs instanceof boa.interpreter.boa.EvalIntRes) {
          if(vrhs instanceof boa.interpreter.boa.EvalIntRes) {
            ...
            ret.setValue(execboa.MathService.mod(this, ivlhs.getValue(), ivrhs.getValue()));
            result = ret;
          }
          else {
            result = null;
  ...
  public ArithOpRemainderDispatchWrapperEval getCachedEval() {
