 ...
 * </p>
 * <ul>
 *   <li>{@link petrinet.model.petrinet.impl.ArcImpl#getSource <em>Source</em>}</li>
 *   <li>{@link petrinet.model.petrinet.impl.ArcImpl#getTarget <em>Target</em>}</li>
 * </ul>
 *
 * @generated
 */
public class ArcImpl extends MinimalEObjectImpl.Container implements Arc {
	...
	public void setSource(Node newSource) {
		if (newSource != source) {
			...
			if (source != null)
				msgs = ((InternalEObject) source).eInverseRemove(this, PetrinetPackage.NODE__OUTGOING, Node.class,
						msgs);
			if (newSource != null)
				msgs = ((InternalEObject) newSource).eInverseAdd(this, PetrinetPackage.NODE__OUTGOING, Node.class,
						msgs);
	...
	public void setTarget(Node newTarget) {
		if (newTarget != target) {
			NotificationChain msgs = null;
			if (target != null)
				msgs = ((InternalEObject) target).eInverseRemove(this, PetrinetPackage.NODE__INCOMMING, Node.class,
						msgs);
			if (newTarget != null)
				msgs = ((InternalEObject) newTarget).eInverseAdd(this, PetrinetPackage.NODE__INCOMMING, Node.class,
						msgs);
