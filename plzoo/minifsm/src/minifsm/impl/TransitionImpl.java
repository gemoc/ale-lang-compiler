...
public class TransitionImpl extends MinimalEObjectImpl.Container implements Transition {
	...
	public void setIncoming(State newIncoming) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, MinifsmPackage.TRANSITION__INCOMING, oldIncoming,
					incoming));
	}
	...
	public State getIncoming() {
		if (incoming != null && incoming.eIsProxy()) {
			...
			if (incoming != oldIncoming) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, MinifsmPackage.TRANSITION__INCOMING,
	...
	public State getOutgoing() {
		if (outgoing != null && outgoing.eIsProxy()) {
			...
			if (outgoing != oldOutgoing) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, MinifsmPackage.TRANSITION__OUTGOING,
	...
	public void setOutgoing(State newOutgoing) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, MinifsmPackage.TRANSITION__OUTGOING, oldOutgoing,
					outgoing));
	}
	 ...
	 */
	public FSM getFsm() {
		if (eContainerFeatureID() != MinifsmPackage.TRANSITION__FSM)
			return null;
	...
	public void setFsm(FSM newFsm) {
		if (newFsm != eInternalContainer()
				|| (eContainerFeatureID() != MinifsmPackage.TRANSITION__FSM && newFsm != null)) {
