...
public class TurtleImpl extends MinimalEObjectImpl.Container implements Turtle {
	...
	@TruffleBoundary
	private void tmp(Segment newSegment) {
		this.getDrawings().add(newSegment);
	}

	public void forward(double steps) {
		this.move((steps)
				* (org.eclipse.emf.ecoretools.ale.core.interpreter.services.TrigoServices.cosinus(this.getHeading())),
				(steps) * (org.eclipse.emf.ecoretools.ale.core.interpreter.services.TrigoServices
						.sinus(this.getHeading())));
	}
