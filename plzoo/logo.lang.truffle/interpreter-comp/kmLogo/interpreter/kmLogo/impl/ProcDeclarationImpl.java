...
@NodeInfo(description = "ProcDeclaration")
public class ProcDeclarationImpl extends InstructionImpl implements ProcDeclaration {
	...
	public EList<Parameter> getArgs() {
		if (args == null) {
			args = new EObjectContainmentEList<Parameter>(kmLogo.interpreter.kmLogo.Parameter.class, this,
					KmLogoPackage.PROC_DECLARATION__ARGS);
		}
		return args;
	}
	...
	public EList<ProcCall> getProcCall() {
		if (procCall == null) {
			procCall = new EObjectContainmentWithInverseEList<ProcCall>(ProcCall.class, this,
					KmLogoPackage.PROC_DECLARATION__PROC_CALL, KmLogoPackage.PROC_CALL__DECLARATION);
		}
		return procCall;
	}
	...
	public EList<Instruction> getInstructions() {
		if (instructions == null) {
			instructions = new EObjectContainmentEList<Instruction>(kmLogo.interpreter.kmLogo.Instruction.class, this,
					KmLogoPackage.PROC_DECLARATION__INSTRUCTIONS);
		}
		return instructions;
	}
	...
	public NotificationChain eInverseAdd(InternalEObject otherEnd, int featureID, NotificationChain msgs2) {
		...
		case KmLogoPackage.PROC_DECLARATION__PROC_CALL:
			return ((org.eclipse.emf.ecore.util.InternalEList<org.eclipse.emf.ecore.InternalEObject>) (org.eclipse.emf.ecore.util.InternalEList<?>) getProcCall())
	...
	public double eval(Turtle turtle) {
		double result;
		Map<ProcDeclaration, RootCallTarget> map = ProcDeclarationMap.map;
		if (!containsKey(map)) {
			CompilerDirectives.transferToInterpreter();
			map.put(this, Truffle.getRuntime().createCallTarget(
					new RootNodeProcDeclaration(this.getInstructions(), null, turtle)));
		}
		result = 0;
		return result;
	}
	...
	@TruffleBoundary
	private boolean containsKey(Map<ProcDeclaration, RootCallTarget> map) {
