...
@NodeInfo(description = "LogoProgram")
public class LogoProgramImpl
		extends org.eclipse.emf.ecoretools.ale.compiler.truffle.MinimalTruffleEObjectImpl.TruffleContainer
		implements LogoProgram {
	...
	public EList<Instruction> getInstructions() {
		if (instructions == null) {
			instructions = new EObjectContainmentEList<Instruction>(kmLogo.interpreter.kmLogo.Instruction.class, this,
					KmLogoPackage.LOGO_PROGRAM__INSTRUCTIONS);
		}
		return instructions;
	}
...
//		System.out.println("eval");
		...
		result = turtle;
		for (Instruction it : ArrayService.toArray(Instruction.class, this.getInstructions())) {
			it.eval(turtle);
		}
		result = turtle;
		...
		org.eclipse.emf.ecoretools.ale.compiler.lib.LogService
				.log(org.eclipse.emf.ecoretools.ale.compiler.lib.CollectionService.size(turtle.getDrawings()));
