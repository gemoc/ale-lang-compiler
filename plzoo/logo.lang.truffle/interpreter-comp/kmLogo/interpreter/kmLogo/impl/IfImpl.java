...
public class IfImpl extends ControlStructureImpl implements If {
		...
		if (newThenPart != thenPart) {
			...
			if (thenPart != null)
				msgs = ((InternalEObject) thenPart).eInverseRemove(this,
						EOPPOSITE_FEATURE_BASE - kmLogo.interpreter.kmLogo.KmLogoPackage.IF__THEN_PART, null, msgs);
			if (newThenPart != null)
			...
			eNotify(new ENotificationImpl(this, Notification.SET, kmLogo.interpreter.kmLogo.KmLogoPackage.IF__THEN_PART,
					newThenPart, newThenPart));
	}
	...
	public NotificationChain basicSetThenPart(Block newThenPart, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET,
					kmLogo.interpreter.kmLogo.KmLogoPackage.IF__THEN_PART, oldThenPart, newThenPart);
			if (msgs == null)
				msgs = notification;
			else
		...
		if (newElsePart != elsePart) {
			...
			if (elsePart != null)
				msgs = ((InternalEObject) elsePart).eInverseRemove(this,
						EOPPOSITE_FEATURE_BASE - kmLogo.interpreter.kmLogo.KmLogoPackage.IF__ELSE_PART, null, msgs);
			if (newElsePart != null)
			...
			eNotify(new ENotificationImpl(this, Notification.SET, kmLogo.interpreter.kmLogo.KmLogoPackage.IF__ELSE_PART,
					newElsePart, newElsePart));
	}
	...
	public NotificationChain basicSetElsePart(Block newElsePart, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET,
					kmLogo.interpreter.kmLogo.KmLogoPackage.IF__ELSE_PART, oldElsePart, newElsePart);
			if (msgs == null)
				msgs = notification;
			else
				msgs.add(notification);
