...
public class LeftImpl extends PrimitiveImpl implements Left {
		...
		if (newAngle != angle) {
			...
			if (angle != null)
				msgs = ((InternalEObject) angle).eInverseRemove(this,
						EOPPOSITE_FEATURE_BASE - kmLogo.interpreter.kmLogo.KmLogoPackage.LEFT__ANGLE, null, msgs);
			if (newAngle != null)
			...
			eNotify(new ENotificationImpl(this, Notification.SET, kmLogo.interpreter.kmLogo.KmLogoPackage.LEFT__ANGLE,
					newAngle, newAngle));
	}
	...
	public NotificationChain basicSetAngle(Expression newAngle, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET,
					kmLogo.interpreter.kmLogo.KmLogoPackage.LEFT__ANGLE, oldAngle, newAngle);
			if (msgs == null)
				msgs = notification;
			else
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
		case kmLogo.interpreter.kmLogo.KmLogoPackage.LEFT__ANGLE:
