...
@NodeInfo(description = "CallStack")
public class CallStackImpl extends MinimalTruffleEObjectImpl.TruffleContainer implements CallStack {
	...
	public EList<StackFrame> getFrames() {
		if (frames == null) {
			frames = new EObjectContainmentEList<StackFrame>(kmLogo.interpreter.kmLogo.StackFrame.class, this,
					KmLogoPackage.CALL_STACK__FRAMES);
		}
		return frames;
	}
