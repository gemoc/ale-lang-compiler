		...
		if (newSteps != steps) {
			...
			if (steps != null)
				msgs = ((InternalEObject) steps).eInverseRemove(this,
						EOPPOSITE_FEATURE_BASE - kmLogo.interpreter.kmLogo.KmLogoPackage.BACK__STEPS, null, msgs);
			if (newSteps != null)
			...
			eNotify(new ENotificationImpl(this, Notification.SET, kmLogo.interpreter.kmLogo.KmLogoPackage.BACK__STEPS,
					newSteps, newSteps));
	}
	...
	public NotificationChain basicSetSteps(Expression newSteps, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET,
					kmLogo.interpreter.kmLogo.KmLogoPackage.BACK__STEPS, oldSteps, newSteps);
			if (msgs == null)
				msgs = notification;
			else
