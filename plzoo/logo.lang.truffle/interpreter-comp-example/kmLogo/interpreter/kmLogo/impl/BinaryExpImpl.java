...
@NodeInfo(description = "BinaryExp")
public abstract class BinaryExpImpl extends ExpressionImpl implements BinaryExp {
		...
		if (newLhs != lhs) {
			...
			if (lhs != null)
				msgs = ((InternalEObject) lhs).eInverseRemove(this,
						EOPPOSITE_FEATURE_BASE - kmLogo.interpreter.kmLogo.KmLogoPackage.BINARY_EXP__LHS, null, msgs);
			if (newLhs != null)
			...
			eNotify(new ENotificationImpl(this, Notification.SET,
					kmLogo.interpreter.kmLogo.KmLogoPackage.BINARY_EXP__LHS, newLhs, newLhs));
	}
	...
	public NotificationChain basicSetLhs(Expression newLhs, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET,
					kmLogo.interpreter.kmLogo.KmLogoPackage.BINARY_EXP__LHS, oldLhs, newLhs);
			if (msgs == null)
				msgs = notification;
			else
		...
		if (newRhs != rhs) {
			...
			if (rhs != null)
				msgs = ((InternalEObject) rhs).eInverseRemove(this,
						EOPPOSITE_FEATURE_BASE - kmLogo.interpreter.kmLogo.KmLogoPackage.BINARY_EXP__RHS, null, msgs);
			if (newRhs != null)
			...
			eNotify(new ENotificationImpl(this, Notification.SET,
					kmLogo.interpreter.kmLogo.KmLogoPackage.BINARY_EXP__RHS, newRhs, newRhs));
	}
	...
	public NotificationChain basicSetRhs(Expression newRhs, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET,
					kmLogo.interpreter.kmLogo.KmLogoPackage.BINARY_EXP__RHS, oldRhs, newRhs);
			if (msgs == null)
				msgs = notification;
			else
				msgs.add(notification);
