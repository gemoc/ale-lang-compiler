...
@NodeInfo(description = "StackFrame")
public class StackFrameImpl extends MinimalTruffleEObjectImpl.TruffleContainer implements StackFrame {
	...
	public EList<Variable> getVariables() {
		if (variables == null) {
			variables = new EObjectContainmentEList<Variable>(kmLogo.interpreter.kmLogo.Variable.class, this,
					KmLogoPackage.STACK_FRAME__VARIABLES);
		}
		return variables;
	}
