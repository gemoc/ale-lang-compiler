...
INTERPRETER_HACKED_JAR=compiled-interpreter-truffle-boa-hacked.jar
...
$GRAALVM_HOME/bin/java -jar $INTERPRETER_HACKED_JAR -XX:-UseJVMCIClassLoader > graal_vm_interpreter_hacked.log
...
echo "graal_vm_interpreter_hacked = $(tail -n 1 graal_vm_interpreter_hacked.log)"
