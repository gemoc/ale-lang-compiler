...
public class ForwardImpl extends PrimitiveImpl implements Forward {
  ...
  public void setSteps(Expression newSteps) {
    if (newSteps != steps) {
    	...
    	if (steps != null)
    		msgs = ((InternalEObject)steps).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - kmLogo.visitor.kmLogo.KmLogoPackage.FORWARD__STEPS, null, msgs);
    	if (newSteps != null)
    		msgs = ((InternalEObject)newSteps).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - kmLogo.visitor.kmLogo.KmLogoPackage.FORWARD__STEPS, null, msgs);
    	msgs = basicSetSteps(newSteps, msgs);
    	if (msgs != null) msgs.dispatch();
    }
    else if (eNotificationRequired())
    	eNotify(new ENotificationImpl(this, Notification.SET, kmLogo.visitor.kmLogo.KmLogoPackage.FORWARD__STEPS, newSteps, newSteps));
  }
  ...
  public NotificationChain basicSetSteps(Expression newSteps, NotificationChain msgs) {
    ...
    if (eNotificationRequired()) {
    	ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, kmLogo.visitor.kmLogo.KmLogoPackage.FORWARD__STEPS, oldSteps, newSteps);
  ...
  public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID,
    ...
    switch(featureID) {
    case kmLogo.visitor.kmLogo.KmLogoPackage.FORWARD__STEPS:
  ...
  public Object accept(VisitorInterface visitor) {
    return visitor.visitkmLogo__Forward(this);}
}
