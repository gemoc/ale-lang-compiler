...
public class TanOperationImpl extends UnaryExpressionOperationImpl implements TanOperation {
  ...
  public double eval(Turtle turtle) {
    double result;
    result = org.eclipse.emf.ecoretools.ale.core.interpreter.services.TrigoServices.tan(((visitor.operation.kmLogo.ExpressionOperation)this.it.getExpression().accept(vis)).eval(turtle));
    return result;
  }
}
