...
public class ExprImpl extends TopLevelCmdImpl implements Expr {
  ...
  private boa.Expr obj;

  public ExprImpl(boa.Expr obj,
  ...
  public void nextLine(boa.Ctx ctx) {
    org.eclipse.emf.ecoretools.ale.compiler.lib.LogService.log(execboa.SerializeService.serialize(rev.$(this.obj).eval(ctx)));
  }
}
