...
public class PetrinetImpl implements Petrinet {
  ...
  public void run() {
    ...
    while (!(stop)) {
      petrinet.lang.petrinet.Node enabledNode = ((petrinet.lang.petrinet.Node)org.eclipse.emf.ecoretools.ale.compiler.lib.CollectionService.head(org.eclipse.emf.ecoretools.ale.compiler.lib.CollectionService.select(this.obj.getNodes(), (n) -> rev.$(n).canFire())));
      if((enabledNode) != (null)) {
