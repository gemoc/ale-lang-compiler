...
public class KmLogoPackageImpl extends EPackageImpl implements KmLogoPackage {
  ...
  public void initializePackageContents() {
    ...
    initEClass(instructionEClass, kmLogo.interpreter.kmLogo.Instruction.class, "Instruction", IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
    initEClass(primitiveEClass, kmLogo.interpreter.kmLogo.Primitive.class, "Primitive", IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
    ...
    initEReference(getBack_Steps(), this.getExpression(),  
    	null, "steps", null, 1, 1,  kmLogo.interpreter.kmLogo.Back.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
    ...
    initEReference(getForward_Steps(), this.getExpression(),  
    	null, "steps", null, 1, 1,  kmLogo.interpreter.kmLogo.Forward.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
    ...
    initEReference(getLeft_Angle(), this.getExpression(),  
    	null, "angle", null, 0, 1,  kmLogo.interpreter.kmLogo.Left.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
    ...
    initEReference(getRight_Angle(), this.getExpression(),  
    	null, "angle", null, 0, 1,  kmLogo.interpreter.kmLogo.Right.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
    ...
    initEReference(getRepeat_Block(), this.getBlock(),  
    	null, "block", null, 1, 1,  kmLogo.interpreter.kmLogo.Repeat.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
    ...
    initEReference(getWhile_Block(), this.getBlock(),  
    	null, "block", null, 1, 1,  kmLogo.interpreter.kmLogo.While.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
    ...
    initEReference(getSegment_Begin(), this.getPoint(),  
    	null, "begin", null, 1, 1,  kmLogo.interpreter.kmLogo.Segment.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
