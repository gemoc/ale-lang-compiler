...
public class LetImpl extends ExprImpl implements Let {
  ...
  public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID,
    ...
    switch(featureID) {
    case interpreter.boa.interpreter.boa.BoaPackage.LET__LHS:
    	return basicSetLhs(null, msgs);
    case interpreter.boa.interpreter.boa.BoaPackage.LET__RHS:
  ...
  public EvalRes eval(Ctx ctx) {
    EvalRes result;
    interpreter.boa.interpreter.boa.Expr lhs = ((interpreter.boa.interpreter.boa.Expr)this.lhs);
        interpreter.boa.interpreter.boa.EvalRes vlhs = ((interpreter.boa.interpreter.boa.EvalRes)lhs.eval(ctx));
        interpreter.boa.interpreter.boa.Ctx nctx = ((interpreter.boa.interpreter.boa.Ctx)interpreter.boa.interpreter.boa.BoaFactory.eINSTANCE.createCtx());
