...
public class CB1Impl extends MinimalEObjectImpl.Container implements CB1 {
	...
	public void setMapca0tocb0mapentry(Entry<EList<CA1>, EList<CB1>> newMapca0tocb0mapentry) {
		if (newMapca0tocb0mapentry != mapca0tocb0mapentry) {
			...
			if (mapca0tocb0mapentry != null)
				msgs = ((InternalEObject) mapca0tocb0mapentry).eInverseRemove(this, TestmaprelationsPackage.MAP_CA1_TO_CB1_MAP_ENTRY__VALUE, Entry.class, msgs); // A
	...
	public NotificationChain eInverseAdd(InternalEObject otherEnd, int featureID,
		...
		switch (featureID) {
			case TestmaprelationsPackage.CB1__MAPCA0TOCB0MAPENTRY :
				if (mapca0tocb0mapentry != null)
					msgs = ((InternalEObject) mapca0tocb0mapentry).eInverseRemove(this, TestmaprelationsPackage.MAP_CA1_TO_CB1_MAP_ENTRY__VALUE, Entry.class, msgs); // D
	...
	public Object accept(VisitorInterface visitor) {
		return visitor.visittestmaprelations__CB1(this);
	}
}
