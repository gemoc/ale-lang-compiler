...
public class CA3Impl extends MinimalEObjectImpl.Container implements CA3 {
	...
	public EList<Entry<EList<CA3>, EList<CB3>>> getMapca0tocb0mapentry() {
		if (mapca0tocb0mapentry == null) {
			mapca0tocb0mapentry = new EObjectWithInverseResolvingEList.ManyInverse<Entry<EList<CA3>, EList<CB3>>>(Entry.class, this, TestmaprelationsPackage.CA3__MAPCA0TOCB0MAPENTRY, TestmaprelationsPackage.MAP_CA3_TO_CB3_MAP_ENTRY__KEY);
		}
	...
	public Object accept(VisitorInterface visitor) {
		return visitor.visittestmaprelations__CA3(this);
	}
}
