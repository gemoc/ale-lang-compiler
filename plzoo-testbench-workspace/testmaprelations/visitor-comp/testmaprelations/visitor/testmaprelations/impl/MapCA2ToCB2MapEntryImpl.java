...
public class MapCA2ToCB2MapEntryImpl extends MinimalEObjectImpl.Container implements BasicEMap.Entry<CA2, CB2> {
	...
	public void setTypedKey(CA2 newKey) {
		if (newKey != key) {
			...
			if (key != null)
				msgs = ((InternalEObject) key).eInverseRemove(this, TestmaprelationsPackage.CA2__MAPCA0TOCB0MAPENTRY, CA2.class, msgs); // A
			if (newKey != null)
	...
	public void setTypedValue(CB2 newValue) {
		if (newValue != value) {
			NotificationChain msgs = null;
			if (value != null)
				msgs = ((InternalEObject) value).eInverseRemove(this, TestmaprelationsPackage.CB2__MAPCA0TOCB0MAPENTRY, CB2.class, msgs); // A
			if (newValue != null)
	...
	public NotificationChain eInverseAdd(InternalEObject otherEnd, int featureID,
		...
		switch (featureID) {
			case TestmaprelationsPackage.MAP_CA2_TO_CB2_MAP_ENTRY__KEY :
				if (key != null)
					msgs = ((InternalEObject) key).eInverseRemove(this, TestmaprelationsPackage.CA2__MAPCA0TOCB0MAPENTRY, CA2.class, msgs); // D
				return basicSetTypedKey((CA2) otherEnd, msgs);
			case TestmaprelationsPackage.MAP_CA2_TO_CB2_MAP_ENTRY__VALUE :
				if (value != null)
					msgs = ((InternalEObject) value).eInverseRemove(this, TestmaprelationsPackage.CB2__MAPCA0TOCB0MAPENTRY, CB2.class, msgs); // D
