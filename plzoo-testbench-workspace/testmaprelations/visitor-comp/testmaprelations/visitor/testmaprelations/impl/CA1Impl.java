...
public class CA1Impl extends MinimalEObjectImpl.Container implements CA1 {
	...
	public void setMapca0tocb0mapentry(Entry<EList<CA1>, EList<CB1>> newMapca0tocb0mapentry) {
		if (newMapca0tocb0mapentry != mapca0tocb0mapentry) {
			...
			if (mapca0tocb0mapentry != null)
				msgs = ((InternalEObject) mapca0tocb0mapentry).eInverseRemove(this, TestmaprelationsPackage.MAP_CA1_TO_CB1_MAP_ENTRY__KEY, Entry.class, msgs); // A
			if (newMapca0tocb0mapentry != null)
				msgs = ((InternalEObject) newMapca0tocb0mapentry).eInverseAdd(this, TestmaprelationsPackage.MAP_CA1_TO_CB1_MAP_ENTRY__KEY, Entry.class, msgs);
	...
	public NotificationChain eInverseAdd(InternalEObject otherEnd, int featureID,
		...
		switch (featureID) {
			case TestmaprelationsPackage.CA1__MAPCA0TOCB0MAPENTRY :
				if (mapca0tocb0mapentry != null)
					msgs = ((InternalEObject) mapca0tocb0mapentry).eInverseRemove(this, TestmaprelationsPackage.MAP_CA1_TO_CB1_MAP_ENTRY__KEY, Entry.class, msgs); // D
	...
	public Object accept(VisitorInterface visitor) {
		return visitor.visittestmaprelations__CA1(this);
	}
}
