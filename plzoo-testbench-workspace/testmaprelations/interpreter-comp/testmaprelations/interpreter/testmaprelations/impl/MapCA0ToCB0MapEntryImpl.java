...
public class MapCA0ToCB0MapEntryImpl extends MinimalEObjectImpl.Container implements BasicEMap.Entry<CA0, CB0> {
	...
	public void setTypedKey(CA0 newKey) {
		if (newKey != key) {
			...
			if (key != null)
				msgs = ((InternalEObject) key).eInverseRemove(this, TestmaprelationsPackage.CA0__MAPCA0TOCB0MAPENTRY, CA0.class, msgs); // A
			if (newKey != null)
	...
	public void setTypedValue(CB0 newValue) {
		if (newValue != value) {
			NotificationChain msgs = null;
			if (value != null)
				msgs = ((InternalEObject) value).eInverseRemove(this, TestmaprelationsPackage.CB0__MAPCA0TOCB0MAPENTRY, CB0.class, msgs); // A
			if (newValue != null)
	...
	public NotificationChain eInverseAdd(InternalEObject otherEnd, int featureID,
		...
		switch (featureID) {
			case TestmaprelationsPackage.MAP_CA0_TO_CB0_MAP_ENTRY__KEY :
				if (key != null)
					msgs = ((InternalEObject) key).eInverseRemove(this, TestmaprelationsPackage.CA0__MAPCA0TOCB0MAPENTRY, CA0.class, msgs); // D
				return basicSetTypedKey((CA0) otherEnd, msgs);
			case TestmaprelationsPackage.MAP_CA0_TO_CB0_MAP_ENTRY__VALUE :
				if (value != null)
					msgs = ((InternalEObject) value).eInverseRemove(this, TestmaprelationsPackage.CB0__MAPCA0TOCB0MAPENTRY, CB0.class, msgs); // D
