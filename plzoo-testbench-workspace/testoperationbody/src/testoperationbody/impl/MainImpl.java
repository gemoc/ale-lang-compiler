...
public class MainImpl extends MinimalEObjectImpl.Container implements Main {
	...
	public EList<ConceptA> getListconcepta() {
		if (listconcepta == null) {
			listconcepta = new EObjectContainmentEList<ConceptA>(ConceptA.class, this,
					TestoperationbodyPackage.MAIN__LISTCONCEPTA);
		}
		return listconcepta;
	}
	...
	public void setSinglebool(boolean newSinglebool) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, TestoperationbodyPackage.MAIN__SINGLEBOOL,
					oldSinglebool, singlebool));
	}
	...
	public void setSingleconcepta(ConceptA newSingleconcepta) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, TestoperationbodyPackage.MAIN__SINGLECONCEPTA,
			...
			if (singleconcepta != oldSingleconcepta) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE,
							TestoperationbodyPackage.MAIN__SINGLECONCEPTA, oldSingleconcepta, singleconcepta));
			}
		}
