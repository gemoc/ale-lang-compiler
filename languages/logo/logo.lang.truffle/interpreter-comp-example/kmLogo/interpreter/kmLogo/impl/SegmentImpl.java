...
@NodeInfo(description = "Segment")
public class SegmentImpl extends MinimalTruffleEObjectImpl.TruffleContainer implements Segment {
	@Child
		...
		if (newBegin != begin) {
			...
			if (begin != null)
				msgs = ((InternalEObject) begin).eInverseRemove(this,
						EOPPOSITE_FEATURE_BASE - kmLogo.interpreter.kmLogo.KmLogoPackage.SEGMENT__BEGIN, null, msgs);
			if (newBegin != null)
			...
			eNotify(new ENotificationImpl(this, Notification.SET,
					kmLogo.interpreter.kmLogo.KmLogoPackage.SEGMENT__BEGIN, newBegin, newBegin));
	}
	...
	public NotificationChain basicSetBegin(Point newBegin, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET,
					kmLogo.interpreter.kmLogo.KmLogoPackage.SEGMENT__BEGIN, oldBegin, newBegin);
			if (msgs == null)
				msgs = notification;
			else
		...
		if (newEnd != end) {
			...
			if (end != null)
				msgs = ((InternalEObject) end).eInverseRemove(this,
						EOPPOSITE_FEATURE_BASE - kmLogo.interpreter.kmLogo.KmLogoPackage.SEGMENT__END, null, msgs);
			if (newEnd != null)
			...
			eNotify(new ENotificationImpl(this, Notification.SET, kmLogo.interpreter.kmLogo.KmLogoPackage.SEGMENT__END,
					newEnd, newEnd));
	}
	...
	public NotificationChain basicSetEnd(Point newEnd, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET,
					kmLogo.interpreter.kmLogo.KmLogoPackage.SEGMENT__END, oldEnd, newEnd);
			if (msgs == null)
				msgs = notification;
			else
				msgs.add(notification);
