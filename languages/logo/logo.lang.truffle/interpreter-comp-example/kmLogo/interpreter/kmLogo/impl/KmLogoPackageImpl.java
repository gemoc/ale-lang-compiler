...
public class KmLogoPackageImpl extends EPackageImpl implements KmLogoPackage {
	...
	public void initializePackageContents() {
		...
		initEClass(instructionEClass, kmLogo.interpreter.kmLogo.Instruction.class, "Instruction", IS_ABSTRACT,
				!IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
		initEClass(primitiveEClass, kmLogo.interpreter.kmLogo.Primitive.class, "Primitive", IS_ABSTRACT, !IS_INTERFACE,
				IS_GENERATED_INSTANCE_CLASS);
		initEClass(backEClass, kmLogo.interpreter.kmLogo.Back.class, "Back", !IS_ABSTRACT, !IS_INTERFACE,
				IS_GENERATED_INSTANCE_CLASS);
		initEReference(getBack_Steps(), this.getExpression(), null, "steps", null, 1, 1,
				kmLogo.interpreter.kmLogo.Back.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE,
				!IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEClass(forwardEClass, kmLogo.interpreter.kmLogo.Forward.class, "Forward", !IS_ABSTRACT, !IS_INTERFACE,
				IS_GENERATED_INSTANCE_CLASS);
		initEReference(getForward_Steps(), this.getExpression(), null, "steps", null, 1, 1,
				kmLogo.interpreter.kmLogo.Forward.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE,
				!IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEClass(leftEClass, kmLogo.interpreter.kmLogo.Left.class, "Left", !IS_ABSTRACT, !IS_INTERFACE,
				IS_GENERATED_INSTANCE_CLASS);
		initEReference(getLeft_Angle(), this.getExpression(), null, "angle", null, 0, 1,
				kmLogo.interpreter.kmLogo.Left.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE,
				!IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEClass(rightEClass, kmLogo.interpreter.kmLogo.Right.class, "Right", !IS_ABSTRACT, !IS_INTERFACE,
				IS_GENERATED_INSTANCE_CLASS);
		initEReference(getRight_Angle(), this.getExpression(), null, "angle", null, 0, 1,
				kmLogo.interpreter.kmLogo.Right.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE,
				!IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEClass(penDownEClass, kmLogo.interpreter.kmLogo.PenDown.class, "PenDown", !IS_ABSTRACT, !IS_INTERFACE,
				IS_GENERATED_INSTANCE_CLASS);
		initEClass(penUpEClass, kmLogo.interpreter.kmLogo.PenUp.class, "PenUp", !IS_ABSTRACT, !IS_INTERFACE,
				IS_GENERATED_INSTANCE_CLASS);
		initEClass(clearEClass, kmLogo.interpreter.kmLogo.Clear.class, "Clear", !IS_ABSTRACT, !IS_INTERFACE,
				IS_GENERATED_INSTANCE_CLASS);
		initEClass(expressionEClass, kmLogo.interpreter.kmLogo.Expression.class, "Expression", IS_ABSTRACT,
				!IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
		initEClass(binaryExpEClass, kmLogo.interpreter.kmLogo.BinaryExp.class, "BinaryExp", IS_ABSTRACT, !IS_INTERFACE,
				IS_GENERATED_INSTANCE_CLASS);
		initEReference(getBinary_exp_Lhs(), this.getExpression(), null, "lhs", null, 1, 1,
				kmLogo.interpreter.kmLogo.BinaryExp.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE,
				!IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getBinary_exp_Rhs(), this.getExpression(), null, "rhs", null, 1, 1,
				kmLogo.interpreter.kmLogo.BinaryExp.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE,
				!IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEClass(unaryExpressionEClass, kmLogo.interpreter.kmLogo.UnaryExpression.class, "UnaryExpression",
				IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
		initEReference(getUnary_expression_Expression(), this.getExpression(), null, "expression", null, 1, 1,
				kmLogo.interpreter.kmLogo.UnaryExpression.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE,
				IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEClass(constantEClass, kmLogo.interpreter.kmLogo.Constant.class, "Constant", !IS_ABSTRACT, !IS_INTERFACE,
				IS_GENERATED_INSTANCE_CLASS);
		initEAttribute(getConstant_Value(), ecorePackage.getEDouble(), "value", null, 0, 1,
				kmLogo.interpreter.kmLogo.Constant.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE,
				!IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEClass(procCallEClass, kmLogo.interpreter.kmLogo.ProcCall.class, "ProcCall", !IS_ABSTRACT, !IS_INTERFACE,
				IS_GENERATED_INSTANCE_CLASS);
		initEReference(getProc_call_Actual_args(), this.getExpression(), null, "actualArgs", null, 0, -1,
				kmLogo.interpreter.kmLogo.ProcCall.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE,
				!IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getProc_call_Declaration(), this.getProcDeclaration(), this.getProc_declaration_Proc_call(),
				"declaration", null, 1, 1, kmLogo.interpreter.kmLogo.ProcCall.class, !IS_TRANSIENT, !IS_VOLATILE,
				IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEClass(procDeclarationEClass, kmLogo.interpreter.kmLogo.ProcDeclaration.class, "ProcDeclaration",
				!IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
		initEAttribute(getProc_declaration_Name(), ecorePackage.getEString(), "name", null, 0, 1,
				kmLogo.interpreter.kmLogo.ProcDeclaration.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE,
				!IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getProc_declaration_Args(), this.getParameter(), null, "args", null, 0, -1,
				kmLogo.interpreter.kmLogo.ProcDeclaration.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE,
				IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getProc_declaration_Proc_call(), this.getProcCall(), this.getProc_call_Declaration(), "procCall",
				null, 0, -1, kmLogo.interpreter.kmLogo.ProcDeclaration.class, !IS_TRANSIENT, !IS_VOLATILE,
				IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getProc_declaration_Instructions(), this.getInstruction(), null, "instructions", null, 0, -1,
				kmLogo.interpreter.kmLogo.ProcDeclaration.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE,
				IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEClass(blockEClass, kmLogo.interpreter.kmLogo.Block.class, "Block", !IS_ABSTRACT, !IS_INTERFACE,
				IS_GENERATED_INSTANCE_CLASS);
		initEReference(getBlock_Instructions(), this.getInstruction(), null, "instructions", null, 0, -1,
				kmLogo.interpreter.kmLogo.Block.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE,
				!IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEClass(ifEClass, kmLogo.interpreter.kmLogo.If.class, "If", !IS_ABSTRACT, !IS_INTERFACE,
				IS_GENERATED_INSTANCE_CLASS);
		initEReference(getIf_Then_part(), this.getBlock(), null, "thenPart", null, 1, 1,
				kmLogo.interpreter.kmLogo.If.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE,
				!IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getIf_Else_part(), this.getBlock(), null, "elsePart", null, 0, 1,
				kmLogo.interpreter.kmLogo.If.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE,
				!IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEClass(controlStructureEClass, kmLogo.interpreter.kmLogo.ControlStructure.class, "ControlStructure",
				!IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
		initEReference(getControl_structure_Condition(), this.getExpression(), null, "condition", null, 0, 1,
				kmLogo.interpreter.kmLogo.ControlStructure.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE,
				IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEClass(repeatEClass, kmLogo.interpreter.kmLogo.Repeat.class, "Repeat", !IS_ABSTRACT, !IS_INTERFACE,
				IS_GENERATED_INSTANCE_CLASS);
		initEReference(getRepeat_Block(), this.getBlock(), null, "block", null, 1, 1,
				kmLogo.interpreter.kmLogo.Repeat.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE,
				!IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEClass(whileEClass, kmLogo.interpreter.kmLogo.While.class, "While", !IS_ABSTRACT, !IS_INTERFACE,
				IS_GENERATED_INSTANCE_CLASS);
		initEReference(getWhile_Block(), this.getBlock(), null, "block", null, 1, 1,
				kmLogo.interpreter.kmLogo.While.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE,
				!IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEClass(parameterEClass, kmLogo.interpreter.kmLogo.Parameter.class, "Parameter", !IS_ABSTRACT, !IS_INTERFACE,
				IS_GENERATED_INSTANCE_CLASS);
		initEAttribute(getParameter_Name(), ecorePackage.getEString(), "name", null, 0, 1,
				kmLogo.interpreter.kmLogo.Parameter.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE,
				!IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEClass(parameterCallEClass, kmLogo.interpreter.kmLogo.ParameterCall.class, "ParameterCall", !IS_ABSTRACT,
				!IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
		initEReference(getParameter_call_Parameter(), this.getParameter(), null, "parameter", null, 1, 1,
				kmLogo.interpreter.kmLogo.ParameterCall.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE,
				!IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEClass(plusEClass, kmLogo.interpreter.kmLogo.Plus.class, "Plus", !IS_ABSTRACT, !IS_INTERFACE,
				IS_GENERATED_INSTANCE_CLASS);
		initEClass(minusEClass, kmLogo.interpreter.kmLogo.Minus.class, "Minus", !IS_ABSTRACT, !IS_INTERFACE,
				IS_GENERATED_INSTANCE_CLASS);
		initEClass(multEClass, kmLogo.interpreter.kmLogo.Mult.class, "Mult", !IS_ABSTRACT, !IS_INTERFACE,
				IS_GENERATED_INSTANCE_CLASS);
		initEClass(divEClass, kmLogo.interpreter.kmLogo.Div.class, "Div", !IS_ABSTRACT, !IS_INTERFACE,
				IS_GENERATED_INSTANCE_CLASS);
		initEClass(equalsEClass, kmLogo.interpreter.kmLogo.Equals.class, "Equals", !IS_ABSTRACT, !IS_INTERFACE,
				IS_GENERATED_INSTANCE_CLASS);
		initEClass(greaterEClass, kmLogo.interpreter.kmLogo.Greater.class, "Greater", !IS_ABSTRACT, !IS_INTERFACE,
				IS_GENERATED_INSTANCE_CLASS);
		initEClass(lowerEClass, kmLogo.interpreter.kmLogo.Lower.class, "Lower", !IS_ABSTRACT, !IS_INTERFACE,
				IS_GENERATED_INSTANCE_CLASS);
		initEClass(cosEClass, kmLogo.interpreter.kmLogo.Cos.class, "Cos", !IS_ABSTRACT, !IS_INTERFACE,
				IS_GENERATED_INSTANCE_CLASS);
		initEClass(sinEClass, kmLogo.interpreter.kmLogo.Sin.class, "Sin", !IS_ABSTRACT, !IS_INTERFACE,
				IS_GENERATED_INSTANCE_CLASS);
		initEClass(tanEClass, kmLogo.interpreter.kmLogo.Tan.class, "Tan", !IS_ABSTRACT, !IS_INTERFACE,
				IS_GENERATED_INSTANCE_CLASS);
		initEClass(logoProgramEClass, kmLogo.interpreter.kmLogo.LogoProgram.class, "LogoProgram", !IS_ABSTRACT,
				!IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
		initEReference(getLogo_program_Instructions(), this.getInstruction(), null, "instructions", null, 0, -1,
				kmLogo.interpreter.kmLogo.LogoProgram.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE,
				!IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEClass(turtleEClass, kmLogo.interpreter.kmLogo.Turtle.class, "Turtle", !IS_ABSTRACT, !IS_INTERFACE,
				IS_GENERATED_INSTANCE_CLASS);
		initEReference(getTurtle_Position(), this.getPoint(), null, "position", null, 1, 1,
				kmLogo.interpreter.kmLogo.Turtle.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE,
				!IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEAttribute(getTurtle_Heading(), ecorePackage.getEDouble(), "heading", null, 0, 1,
				kmLogo.interpreter.kmLogo.Turtle.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE,
				!IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEAttribute(getTurtle_Pen_up(), ecorePackage.getEBoolean(), "penUp", null, 0, 1,
				kmLogo.interpreter.kmLogo.Turtle.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE,
				!IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getTurtle_Drawings(), this.getSegment(), null, "drawings", null, 0, -1,
				kmLogo.interpreter.kmLogo.Turtle.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE,
				!IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getTurtle_Call_stack(), this.getCallStack(), null, "callStack", null, 1, 1,
				kmLogo.interpreter.kmLogo.Turtle.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE,
				!IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEClass(pointEClass, kmLogo.interpreter.kmLogo.Point.class, "Point", !IS_ABSTRACT, !IS_INTERFACE,
				IS_GENERATED_INSTANCE_CLASS);
		initEAttribute(getPoint_X(), ecorePackage.getEDouble(), "x", null, 0, 1, kmLogo.interpreter.kmLogo.Point.class,
				!IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEAttribute(getPoint_Y(), ecorePackage.getEDouble(), "y", null, 0, 1, kmLogo.interpreter.kmLogo.Point.class,
				!IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEClass(segmentEClass, kmLogo.interpreter.kmLogo.Segment.class, "Segment", !IS_ABSTRACT, !IS_INTERFACE,
				IS_GENERATED_INSTANCE_CLASS);
		initEReference(getSegment_Begin(), this.getPoint(), null, "begin", null, 1, 1,
				kmLogo.interpreter.kmLogo.Segment.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE,
				!IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getSegment_End(), this.getPoint(), null, "end", null, 1, 1,
				kmLogo.interpreter.kmLogo.Segment.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE,
				!IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEClass(callStackEClass, kmLogo.interpreter.kmLogo.CallStack.class, "CallStack", !IS_ABSTRACT, !IS_INTERFACE,
				IS_GENERATED_INSTANCE_CLASS);
		initEReference(getCall_stack_Frames(), this.getStackFrame(), null, "frames", null, 0, -1,
				kmLogo.interpreter.kmLogo.CallStack.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE,
				!IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEClass(stackFrameEClass, kmLogo.interpreter.kmLogo.StackFrame.class, "StackFrame", !IS_ABSTRACT,
				!IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
		initEReference(getStack_frame_Variables(), this.getVariable(), null, "variables", null, 0, -1,
				kmLogo.interpreter.kmLogo.StackFrame.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE,
				!IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEClass(variableEClass, kmLogo.interpreter.kmLogo.Variable.class, "Variable", !IS_ABSTRACT, !IS_INTERFACE,
				IS_GENERATED_INSTANCE_CLASS);
		initEAttribute(getVariable_Name(), ecorePackage.getEString(), "name", null, 1, 1,
				kmLogo.interpreter.kmLogo.Variable.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE,
				!IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEAttribute(getVariable_Value(), ecorePackage.getEDouble(), "value", null, 1, 1,
				kmLogo.interpreter.kmLogo.Variable.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE,
				!IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		// Create resource
