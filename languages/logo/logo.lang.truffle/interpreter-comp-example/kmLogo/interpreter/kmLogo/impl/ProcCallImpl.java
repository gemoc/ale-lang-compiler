...
public class ProcCallImpl extends ExpressionImpl implements ProcCall {
	...
	private ProcDeclarationDispatchEval dispatchNode;

	protected ProcCallImpl() {
		super();
		this.dispatchNode = ProcDeclarationDispatchEvalNodeGen.create();
	}
	...
	public double eval(Turtle turtle) {
		...
		result = 0.0;
		dispatchNode.executeDispatch(this.getDeclaration().getCached(), new Object[] { turtle });
