...
public class ProcDeclarationImpl extends InstructionImpl implements ProcDeclaration {
	...
	@CompilationFinal
	private ProcDeclarationDispatchWrapperEval cached;

	protected ProcDeclarationImpl() {
		super();
		setCached(new ProcDeclarationDispatchWrapperEval(this));
	}
	...
	@Override
	public ProcDeclarationDispatchWrapperEval getCached() {
		return cached;
	}
}
