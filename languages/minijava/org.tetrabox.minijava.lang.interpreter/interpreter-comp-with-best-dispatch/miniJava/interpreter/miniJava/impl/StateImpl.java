...
//  @Child
  ...
  @CompilationFinal
  private StateDispatchWrapperPushNewContext cachedPushNewContext;

  @CompilationFinal
  private StateDispatchWrapperPushNewFrame cachedPushNewFrame;

  protected StateImpl() {
    super();
    this.cachedPushNewContext = new miniJava.interpreter.miniJava.impl.StateDispatchWrapperPushNewContext(this);
    this.cachedPushNewFrame = new miniJava.interpreter.miniJava.impl.StateDispatchWrapperPushNewFrame(this);
  }
  ...
  public StateDispatchWrapperPushNewContext getCachedPushNewContext() {
    return this.cachedPushNewContext;
  }

  public StateDispatchWrapperPushNewFrame getCachedPushNewFrame() {
    return this.cachedPushNewFrame;
  }
}
