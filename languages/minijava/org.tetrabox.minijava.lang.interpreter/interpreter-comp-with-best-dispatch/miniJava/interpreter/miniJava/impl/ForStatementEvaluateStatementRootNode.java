...
public class ForStatementEvaluateStatementRootNode extends RootNode {
  @Child
  private ForStatement it;

  public ForStatementEvaluateStatementRootNode(ForStatement it) {
    super(null);
    this.it = it;
  }
