...
public class MiniJavaSemanticSequencer extends AbstractDelegatingSemanticSequencer {
	...
	public void sequence(ISerializationContext context, EObject semanticObject) {
		...
		if (epackage == MiniJavaPackage.eINSTANCE)
			...
			case MiniJavaPackage.PARAMETER:
				sequence_Parameter(context, (miniJava.visitor.miniJava.Parameter) semanticObject); 
				return; 
	 ...
	 */
	protected void sequence_Parameter(ISerializationContext context, miniJava.visitor.miniJava.Parameter semanticObject) {
		if (errorAcceptor != null) {
