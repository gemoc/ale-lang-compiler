...
public class MultiplicationImpl extends ExpressionImpl implements Multiplication {
	...
	public NotificationChain basicSetLeft(Expression newLeft, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET,
					MiniJavaPackage.MULTIPLICATION__LEFT, oldLeft, newLeft);
			if (msgs == null)
				msgs = notification;
			else
	...
	public NotificationChain basicSetRight(Expression newRight, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET,
					MiniJavaPackage.MULTIPLICATION__RIGHT, oldRight, newRight);
			if (msgs == null)
				msgs = notification;
			else
				msgs.add(notification);
		...
		if (newLeft != left) {
			...
			if (left != null)
				msgs = ((InternalEObject) left).eInverseRemove(this,
						EOPPOSITE_FEATURE_BASE - MiniJavaPackage.MULTIPLICATION__LEFT, null, msgs);
			if (newLeft != null)
			...
			eNotify(new ENotificationImpl(this, Notification.SET, MiniJavaPackage.MULTIPLICATION__LEFT, newLeft,
					newLeft));
	}
		...
		if (newRight != right) {
			...
			if (right != null)
				msgs = ((InternalEObject) right).eInverseRemove(this,
						EOPPOSITE_FEATURE_BASE - MiniJavaPackage.MULTIPLICATION__RIGHT, null, msgs);
			if (newRight != null)
			...
			eNotify(new ENotificationImpl(this, Notification.SET, MiniJavaPackage.MULTIPLICATION__RIGHT, newRight,
					newRight));
	}
}
