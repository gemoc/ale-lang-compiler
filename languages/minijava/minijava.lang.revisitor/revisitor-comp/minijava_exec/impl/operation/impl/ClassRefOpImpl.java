...
public class ClassRefOpImpl extends SingleTypeRefOpImpl implements ClassRefOp {
  ...
  private ClassRef obj;

  public ClassRefOpImpl(ClassRef obj,
  ...
  public boolean compare(TypeRef other) {
    ...
    if(other instanceof ClassRef) {
      ...
      result = ((Boolean) (EqualService.equals((this.obj.getReferencedClass()), (ocr.getReferencedClass()))));
    }
    else {
