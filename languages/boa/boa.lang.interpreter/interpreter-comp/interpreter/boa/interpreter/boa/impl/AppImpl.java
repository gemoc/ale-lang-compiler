	...
	public EvalRes eval(Ctx ctx) {
		...
		if (vlhs instanceof EvalFunRes) {
			if (vlhs instanceof EvalBoundFunRes) {
				...
				callCtx.getEnv().putAll((EMap) (fct.getCtx().getEnv()));
				callCtx.getEnv().put((String) (fct.getName()), (EvalRes) (vrhs));
				callCtx.getTh().replaceWith((EMap) (fct.getTh()));
				...
				if (fe instanceof EvalFunRes) {
					...
					tmp.getTh().replaceWith((EMap) (fct.getTh()));
					result = (EvalRes) (tmp) ;
				}
				else {
					result = (EvalRes) (fe) ;
				...
				callCtx.getEnv().putAll((EMap) (fct.getCtx().getEnv()));
				callCtx.getEnv().put((String) (fct.getName()), (EvalRes) (vrhs));
				callCtx.getTh().replaceWith((EMap) (ctx.getTh()));
				...
				if (fe instanceof EvalFunRes) {
					...
					tmp.setCtx(fun.getCtx());
					tmp.setName(fun.getName());
					tmp.getTh().replaceWith((EMap) (ctx.getTh()));
					result = (EvalRes) (tmp) ;
				}
				else {
					result = (EvalRes) (fe) ;
