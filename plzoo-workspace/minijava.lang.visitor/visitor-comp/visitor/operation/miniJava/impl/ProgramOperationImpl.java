...
public class ProgramOperationImpl implements ProgramOperation {
	...
	public void initialize(EList args) {
		...
		state.setOutputStream(miniJava.visitor.miniJava.MiniJavaFactory.eINSTANCE.createOutputStream());
		state.setRootFrame(miniJava.visitor.miniJava.MiniJavaFactory.eINSTANCE.createFrame());
