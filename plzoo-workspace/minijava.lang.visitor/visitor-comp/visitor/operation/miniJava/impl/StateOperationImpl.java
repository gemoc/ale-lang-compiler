...
public class StateOperationImpl implements StateOperation {
	...
	public Frame findCurrentFrame() {
		...
		if(EqualService.equals((this.it.getFrameCache()), (null))) {
			this.it.setFrameCache(((visitor.operation.miniJava.FrameOperation)this.it.getRootFrame().accept(vis)).findCurrentFrame());
		}
	...
	public Context findCurrentContext() {
		...
		if(EqualService.equals((this.it.getContextCache()), (null))) {
			this.it.setContextCache(((visitor.operation.miniJava.FrameOperation)this.it.getRootFrame().accept(vis)).findCurrentContext());
		}
	...
	public void pushNewFrame(ObjectInstance receiver, Call c, Context newContext) {
		...
		((visitor.operation.miniJava.StateOperation)this.it.accept(vis)).findCurrentFrame().setChildFrame(newFrame);
	...
	public void popCurrentFrame() {
		...
		((visitor.operation.miniJava.StateOperation)this.it.accept(vis)).findCurrentFrame().setParentFrame(null);
		this.it.setContextCache(null);
