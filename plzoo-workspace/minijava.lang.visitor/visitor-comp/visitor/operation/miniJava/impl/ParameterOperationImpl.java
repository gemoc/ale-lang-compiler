...
public class ParameterOperationImpl extends SymbolOperationImpl implements ParameterOperation {
	...
	public boolean compare(Parameter other) {
		boolean result;
		result = ((org.eclipse.emf.ecoretools.ale.compiler.lib.EqualService.equals((this.it.getName()), (other.getName()))) && (((visitor.operation.miniJava.TypeRefOperation)this.it.getTypeRef().accept(vis)).compare((miniJava.visitor.miniJava.TypeRef) (other.getTypeRef()))));
		return result;
	}
}
