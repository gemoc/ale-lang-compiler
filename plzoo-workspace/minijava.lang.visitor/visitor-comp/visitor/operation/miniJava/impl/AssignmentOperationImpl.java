		...
		if(assignee instanceof SymbolRef) {
			...
			if(assignee instanceof VariableDeclaration) {
				...
				if(assignee instanceof FieldAccess) {
					...
					ObjectRefValue realReceiverValue = ((ObjectRefValue) (assigneeFieldAccess.getReceiver().evaluateExpression(state)));
					...
					if(assignee instanceof ArrayAccess) {
						...
						ArrayRefValue arrayRefValue = ((ArrayRefValue) (assigneeArrayAccess.getObject().evaluateExpression(state)));
						ArrayInstance array = ((ArrayInstance) (arrayRefValue.getInstance()));
						IntegerValue integerValue = ((IntegerValue) (assigneeArrayAccess.getIndex().evaluateExpression(state)));
