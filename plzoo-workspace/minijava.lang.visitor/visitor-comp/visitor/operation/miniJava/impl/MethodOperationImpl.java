...
public class MethodOperationImpl extends MemberOperationImpl implements MethodOperation {
	...
	public Method findOverride(Clazz c) {
		Method result;
		if(!(minijava.MapService.containsKey(this.it.getCache(), c))) {
			...
			if(CollectionService.exists(c.getMembers(), (x) -> EqualService.equals((x), (that)))) {
				...
				while ((((i) < (org.eclipse.emf.ecoretools.ale.compiler.lib.CollectionService.size(c.getMembers()))) && (org.eclipse.emf.ecoretools.ale.compiler.lib.EqualService.equals((found), (null))))) {
					...
					if(tmpm instanceof Method) {
						...
						if(((org.eclipse.emf.ecoretools.ale.compiler.lib.EqualService.equals((m.getName()), (this.it.getName()))) && (org.eclipse.emf.ecoretools.ale.compiler.lib.EqualService.equals((org.eclipse.emf.ecoretools.ale.compiler.lib.CollectionService.size(m.getParams())), (org.eclipse.emf.ecoretools.ale.compiler.lib.CollectionService.size(this.it.getParams())))))) {
							boolean compared = ((boolean) (((TypeRefOperation)m.getTypeRef().accept(vis)).compare((TypeRef) (this.it.getTypeRef()))));
							EClassifier int = null;
							j = 0;
							...
							while ((((j) < (paramlgt)) && (alltrue))) {
								...
								Parameter tmpp = ((Parameter) (CollectionService.head(CollectionService.select(this.it.getParams(), (p2) -> p1.compare(p2)))));
			...
			minijava.MapService.put(this.it.getCache(), c, result);
		}
		else {
