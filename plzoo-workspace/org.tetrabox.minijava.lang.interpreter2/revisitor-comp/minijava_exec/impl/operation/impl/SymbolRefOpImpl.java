...
public class SymbolRefOpImpl extends ExpressionOpImpl implements SymbolRefOp {
  ...
  private SymbolRef obj;

  public SymbolRefOpImpl(SymbolRef obj,
  ...
  public Value evaluateExpression(State state) {
    Value result;
    result = rev.$((Value)rev.$((Context)rev.$((State)state).findCurrentContext()).findBinding(((Symbol) (this.obj.getSymbol()))).getValue()).copyj();
    return result;
  }
}
