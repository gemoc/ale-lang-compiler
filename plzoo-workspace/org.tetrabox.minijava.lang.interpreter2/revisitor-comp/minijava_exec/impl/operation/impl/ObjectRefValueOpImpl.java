...
public class ObjectRefValueOpImpl extends ValueOpImpl implements ObjectRefValueOp {
  ...
  private ObjectRefValue obj;

  public ObjectRefValueOpImpl(ObjectRefValue obj,
  ...
  public String customToString() {
    String result;
    result = this.obj.getInstance().toString();
    return result;
  }
