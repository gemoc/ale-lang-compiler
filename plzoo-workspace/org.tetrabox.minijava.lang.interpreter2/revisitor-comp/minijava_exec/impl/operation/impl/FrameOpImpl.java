...
public class FrameOpImpl implements FrameOp {
  ...
  public Context findCurrentContext() {
    ...
    if(!EqualService.equals((this.obj.getChildFrame()), (null))) {
      result = rev.$((Frame)this.obj.getChildFrame()).findCurrentContext();
    }
    else {
      if(!EqualService.equals((this.obj.getRootContext()), (null))) {
        result = rev.$((Context)this.obj.getRootContext()).findCurrentContext();
      }
      else {
        result = null;
      }
  ...
  public Frame findCurrentFrame() {
    Frame result;
    if(!EqualService.equals((this.obj.getChildFrame()), (null))) {
      result = rev.$((Frame)this.obj.getChildFrame()).findCurrentFrame();
    }
    else {
      result = this.obj;
    }
