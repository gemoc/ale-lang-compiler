...
public class WhileStatementImpl extends StatementImpl implements WhileStatement {
	...
	public void evaluateStatement(State state) {
		BooleanValue continueWhile = ((BooleanValue) (((BooleanValue) (((Expression) (this.condition)).evaluateExpression((State) (state))))));
		while (continueWhile.isValue()) {
			((Block) (this.block)).evaluateStatement((State) (state));
			BooleanValue continueWhile2 = ((BooleanValue) (((BooleanValue) (((Expression) (this.condition)).evaluateExpression((State) (state))))));
