...
public class SymbolBindingImpl extends MinimalEObjectImpl.Container implements SymbolBinding {
	...
	public NotificationChain basicSetValue(Value newValue, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET,
					MiniJavaPackage.SYMBOL_BINDING__VALUE, oldValue, newValue);
			if (msgs == null)
				msgs = notification;
			else
	...
	public void setSymbol(Symbol newSymbol) {
		...
		symbol = newSymbol;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, MiniJavaPackage.SYMBOL_BINDING__SYMBOL, oldSymbol,
					symbol));
	}
		...
		if (newValue != value) {
			...
			if (value != null)
				msgs = ((InternalEObject) value).eInverseRemove(this,
						EOPPOSITE_FEATURE_BASE - MiniJavaPackage.SYMBOL_BINDING__VALUE, null, msgs);
			if (newValue != null)
			...
			eNotify(new ENotificationImpl(this, Notification.SET, MiniJavaPackage.SYMBOL_BINDING__VALUE, newValue,
					newValue));
	}
}
