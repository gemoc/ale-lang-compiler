...
public class PrintStatementEvaluateStatementRootNode extends RootNode {
  @Child
  private PrintStatement it;

  public PrintStatementEvaluateStatementRootNode(PrintStatement it) {
    super(null);
    this.it = it;
  }
