...
public class PrintStatementImpl extends StatementImpl implements PrintStatement {
	...
	public void evaluateStatement(State state) {
		String res = ((String) (((miniJava.interpreter.miniJava.Expression) (this.expression)).evaluateExpression((miniJava.interpreter.miniJava.State) (state)).customToString()));
		((State) (state)).println((Nothing) (res));
	}
}
