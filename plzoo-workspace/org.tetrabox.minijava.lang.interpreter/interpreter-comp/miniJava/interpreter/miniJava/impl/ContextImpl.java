...
public class ContextImpl extends MinimalEObjectImpl.Container implements Context {
	...
	public SymbolBinding findBinding(Symbol symbol) {
		...
		if (!(MapService.containsKey((Nothing) (this.getCache()), (Symbol) (symbol)))) {
			...
			if (!EqualService.equals((binding), (null))) {
				MapService.put((Nothing) (this.getCache()), (Symbol) (symbol), (SymbolBinding) (binding));
			}
			else {
				if (!EqualService.equals((this.getParentContext()), (null))) {
					...
					MapService.put((Nothing) (this.getCache()), (Symbol) (symbol), (Nothing) (binding2));
				}
				else {
