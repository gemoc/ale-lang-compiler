...
public class ContextImpl extends MinimalTruffleEObjectImpl.TruffleContainer implements Context {
		...
		if (newChildContext != childContext) {
			...
			if (childContext != null)
				msgs = ((InternalEObject) childContext).eInverseRemove(this, MiniJavaPackage.CONTEXT__PARENT_CONTEXT,
						miniJava.interpreter.miniJava.Context.class, msgs);
	...
	public void eSet(int featureID, Object newValue) {
		...
		case MiniJavaPackage.CONTEXT__BINDINGS:
			getBindings().clear();
			getBindings()
					.addAll((java.util.Collection<? extends miniJava.interpreter.miniJava.SymbolBinding>) newValue);
			return;
	...
	public SymbolBinding findBinding(Symbol symbol) {
		...
		if (!(minijava.MapService.containsKey(this.getCache(), symbol))) {
			miniJava.interpreter.miniJava.SymbolBinding binding = ((miniJava.interpreter.miniJava.SymbolBinding) org.eclipse.emf.ecoretools.ale.compiler.lib.CollectionService
					.head(org.eclipse.emf.ecoretools.ale.compiler.lib.CollectionService.select(this.getBindings(),
							(x) -> org.eclipse.emf.ecoretools.ale.compiler.lib.EqualService.equals((x.getSymbol()),
									(symbol)))));
			if ((binding) != (null)) {
				minijava.MapService.put(this.getCache(), symbol, binding);
			} else {
				if ((this.getParentContext()) != (null)) {
					miniJava.interpreter.miniJava.SymbolBinding binding2 = ((miniJava.interpreter.miniJava.SymbolBinding) this
							.getParentContext().findBinding(symbol));
