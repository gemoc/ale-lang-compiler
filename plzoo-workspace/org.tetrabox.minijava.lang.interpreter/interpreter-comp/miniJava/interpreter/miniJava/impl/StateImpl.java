...
public class StateImpl extends MinimalTruffleEObjectImpl.TruffleContainer implements State {
		...
		if (newRootFrame != rootFrame) {
			...
			if (rootFrame != null)
				msgs = ((InternalEObject) rootFrame).eInverseRemove(this,
						EOPPOSITE_FEATURE_BASE - miniJava.interpreter.miniJava.MiniJavaPackage.STATE__ROOT_FRAME, null,
						msgs);
			...
			eNotify(new ENotificationImpl(this, Notification.SET,
					miniJava.interpreter.miniJava.MiniJavaPackage.STATE__ROOT_FRAME, newRootFrame, newRootFrame));
	}
	...
	public NotificationChain basicSetRootFrame(Frame newRootFrame, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET,
					miniJava.interpreter.miniJava.MiniJavaPackage.STATE__ROOT_FRAME, oldRootFrame, newRootFrame);
			if (msgs == null)
				msgs = notification;
			else
	...
	public EList<ObjectInstance> getObjectsHeap() {
		if (objectsHeap == null) {
			objectsHeap = new EObjectContainmentEList<ObjectInstance>(
					miniJava.interpreter.miniJava.ObjectInstance.class, this, MiniJavaPackage.STATE__OBJECTS_HEAP);
		}
		return objectsHeap;
	}
		...
		if (newOutputStream != outputStream) {
			...
			if (outputStream != null)
				msgs = ((InternalEObject) outputStream).eInverseRemove(this,
						EOPPOSITE_FEATURE_BASE - miniJava.interpreter.miniJava.MiniJavaPackage.STATE__OUTPUT_STREAM,
						null, msgs);
			...
			eNotify(new ENotificationImpl(this, Notification.SET,
					miniJava.interpreter.miniJava.MiniJavaPackage.STATE__OUTPUT_STREAM, newOutputStream,
					newOutputStream));
	}
	...
	public NotificationChain basicSetOutputStream(OutputStream newOutputStream, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET,
					miniJava.interpreter.miniJava.MiniJavaPackage.STATE__OUTPUT_STREAM, oldOutputStream,
					newOutputStream);
			if (msgs == null)
				msgs = notification;
			else
	...
	public EList<ArrayInstance> getArraysHeap() {
		if (arraysHeap == null) {
			arraysHeap = new EObjectContainmentEList<ArrayInstance>(miniJava.interpreter.miniJava.ArrayInstance.class,
					this, MiniJavaPackage.STATE__ARRAYS_HEAP);
		}
		return arraysHeap;
	}
	...
	public void eSet(int featureID, Object newValue) {
		...
		case MiniJavaPackage.STATE__OBJECTS_HEAP:
			...
			getObjectsHeap()
					.addAll((java.util.Collection<? extends miniJava.interpreter.miniJava.ObjectInstance>) newValue);
			return;
		...
		case MiniJavaPackage.STATE__ARRAYS_HEAP:
			getArraysHeap().clear();
			getArraysHeap()
					.addAll((java.util.Collection<? extends miniJava.interpreter.miniJava.ArrayInstance>) newValue);
			return;
	...
	private boolean extracted() {
		return org.eclipse.emf.ecoretools.ale.compiler.lib.EqualService.equals((this.contextCache), (null));
	}

	public void pushNewContext() {
		miniJava.interpreter.miniJava.Context newContext = ((miniJava.interpreter.miniJava.Context) miniJava.interpreter.miniJava.MiniJavaFactory.eINSTANCE
				.createContext());
		miniJava.interpreter.miniJava.Context currCtx = ((miniJava.interpreter.miniJava.Context) this
				.findCurrentContext());
		if ((currCtx) != (null)) {
	...
	public void popCurrentContext() {
		miniJava.interpreter.miniJava.Context currContext = ((miniJava.interpreter.miniJava.Context) this
				.findCurrentContext());
		miniJava.interpreter.miniJava.Context newCurrent = ((miniJava.interpreter.miniJava.Context) currContext
				.getParentContext());
	...
	public void pushNewFrame(ObjectInstance receiver, Call c, Context newContext) {
		miniJava.interpreter.miniJava.Frame newFrame = ((miniJava.interpreter.miniJava.Frame) miniJava.interpreter.miniJava.MiniJavaFactory.eINSTANCE
				.createFrame());
	...
	public void popCurrentFrame() {
		miniJava.interpreter.miniJava.Frame newCurrent = ((miniJava.interpreter.miniJava.Frame) this.findCurrentFrame()
				.getParentFrame());
