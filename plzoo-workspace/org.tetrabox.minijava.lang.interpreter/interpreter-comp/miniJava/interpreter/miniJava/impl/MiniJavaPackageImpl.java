...
public class MiniJavaPackageImpl extends EPackageImpl implements MiniJavaPackage {
  ...
  public void initializePackageContents() {
    ...
    initEAttribute(getImport_Imported_namespace(), ecorePackage.getEString(), "importedNamespace", null, 0, 1,  miniJava.interpreter.miniJava.Import.class, !IS_TRANSIENT,!IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);				
    ...
    initEAttribute(getType_declaration_Access_level(), this.getAccessLevel(), "accessLevel", null, 0, 1,  miniJava.interpreter.miniJava.TypeDeclaration.class, !IS_TRANSIENT,!IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
    initEReference(getType_declaration_Implementz(), this.getInterface(),  
    ...
    initEReference(getType_declaration_Members(), this.getMember(),  
    ...
    initEReference(getClazz_Super_class(), this.getClazz(),  
    ...
    initEReference(getField_Default_value(), this.getExpression(),  
    ...
    initEReference(getPrint_statement_Expression(), this.getExpression(),  
    ...
    initEReference(getIf_statement_Expression(), this.getExpression(),  
    ...
    initEReference(getIf_statement_Then_block(), this.getBlock(),  
    ...
    initEReference(getIf_statement_Else_block(), this.getBlock(),  
    ...
    initEReference(getWhile_statement_Condition(), this.getExpression(),  
    ...
    initEReference(getWhile_statement_Block(), this.getBlock(),  
    ...
    initEReference(getFor_statement_Declaration(), this.getAssignment(),  
    ...
    initEReference(getFor_statement_Condition(), this.getExpression(),  
    ...
    initEReference(getFor_statement_Progression(), this.getAssignment(),  
    ...
    initEReference(getFor_statement_Block(), this.getBlock(),  
    ...
    initEReference(getClass_ref_Referenced_class(), this.getTypeDeclaration(),  
    ...
    initEAttribute(getNamed_element_Name(), ecorePackage.getEString(), "name", null, 0, 1,  miniJava.interpreter.miniJava.NamedElement.class, !IS_TRANSIENT,!IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);				
    ...
    initEReference(getTyped_declaration_Type_ref(), this.getTypeRef(),  
    ...
    initEReference(getArray_type_ref_Type_ref(), this.getSingleTypeRef(),  
    ...
    initEReference(getSuperior_or_equal_Left(), this.getExpression(),  
    ...
    initEReference(getSuperior_or_equal_Right(), this.getExpression(),  
    ...
    initEReference(getInferior_or_equal_Left(), this.getExpression(),  
    ...
    initEReference(getInferior_or_equal_Right(), this.getExpression(),  
    ...
    initEReference(getArray_access_Object(), this.getExpression(),  
    ...
    initEReference(getArray_access_Index(), this.getExpression(),  
    ...
    initEReference(getArray_length_Array(), this.getExpression(),  
    ...
    initEReference(getField_access_Receiver(), this.getExpression(),  
    ...
    initEReference(getField_access_Field(), this.getField(),  
    ...
    initEReference(getMethod_call_Receiver(), this.getExpression(),  
    ...
    initEReference(getMethod_call_Method(), this.getMethod(),  
    ...
    initEReference(getMethod_call_Args(), this.getExpression(),  
    ...
    initEAttribute(getString_constant_Value(), ecorePackage.getEString(), "value", null, 0, 1,  miniJava.interpreter.miniJava.StringConstant.class, !IS_TRANSIENT,!IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);				
    ...
    initEAttribute(getInt_constant_Value(), ecorePackage.getEInt(), "value", null, 0, 1,  miniJava.interpreter.miniJava.IntConstant.class, !IS_TRANSIENT,!IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);				
    ...
    initEAttribute(getBool_constant_Value(), ecorePackage.getEString(), "value", null, 0, 1,  miniJava.interpreter.miniJava.BoolConstant.class, !IS_TRANSIENT,!IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);				
    ...
    initEReference(getNew_object_Type(), this.getClazz(),  
    ...
    initEReference(getNew_object_Args(), this.getExpression(),  
    ...
    initEReference(getNew_array_Type(), this.getTypeRef(),  
    ...
    initEReference(getNew_array_Size(), this.getExpression(),  
    ...
    initEReference(getSymbol_ref_Symbol(), this.getSymbol(),  
    ...
    initEReference(getContext_Parent_context(), this.getContext(),  
    ...
    initEReference(getSymbol_binding_Value(), this.getValue(),  
    ...
    initEReference(getSymbol_binding_Symbol(), this.getSymbol(),  
    ...
    initEReference(getField_binding_Field(), this.getField(),  
    ...
    initEReference(getField_binding_Value(), this.getValue(),  
    ...
    initEAttribute(getString_value_Value(), ecorePackage.getEString(), "value", null, 0, 1,  miniJava.interpreter.miniJava.StringValue.class, !IS_TRANSIENT,!IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);				
    ...
    initEAttribute(getBoolean_value_Value(), ecorePackage.getEBoolean(), "value", null, 0, 1,  miniJava.interpreter.miniJava.BooleanValue.class, !IS_TRANSIENT,!IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);				
    ...
    initEAttribute(getOutput_stream_Stream(), ecorePackage.getEString(), "stream", null, 0, -1,  miniJava.interpreter.miniJava.OutputStream.class, !IS_TRANSIENT,!IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, !IS_UNIQUE, !IS_DERIVED, IS_ORDERED);				
    ...
    initEReference(getState_Root_frame(), this.getFrame(),  
    ...
    initEReference(getState_Objects_heap(), this.getObjectInstance(),  
    ...
    initEReference(getState_Output_stream(), this.getOutputStream(),  
    ...
    initEReference(getState_Arrays_heap(), this.getArrayInstance(),  
    ...
    initEReference(getState_Context_cache(), this.getContext(),  
    ...
    initEReference(getState_Frame_cache(), this.getFrame(),  
    ...
    initEReference(getFrame_Child_frame(), this.getFrame(),  
    	this.getFrame_Parent_frame(), "childFrame", null, 0, 1,  miniJava.interpreter.miniJava.Frame.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
    initEReference(getFrame_Parent_frame(), this.getFrame(),  
    	this.getFrame_Child_frame(), "parentFrame", null, 0, 1,  miniJava.interpreter.miniJava.Frame.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
    initEReference(getFrame_Root_context(), this.getContext(),  
    ...
    initEReference(getFrame_Return_value(), this.getValue(),  
    ...
    initEReference(getNew_call_Newz(), this.getNewObject(),  
    ...
    initEReference(getMethod_call2_Methodcall(), this.getMethodCall(),  
    ...
    initEReference(getObject_instance_Fieldbindings(), this.getFieldBinding(),  
    ...
    initEReference(getObject_instance_Type(), this.getClazz(),  
    ...
    initEReference(getArray_instance_Value(), this.getValue(),  
    ...
    initEAttribute(getArray_instance_Size(), ecorePackage.getEInt(), "size", null, 0, 1,  miniJava.interpreter.miniJava.ArrayInstance.class, !IS_TRANSIENT,!IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);				
    ...
    initEReference(getObject_ref_value_Instance(), this.getObjectInstance(),  
  ...
  public EAttribute getImport_Imported_namespace() {
    return (EAttribute) importEClass.getEStructuralFeatures().get(0);
  }

  public EAttribute getType_declaration_Access_level() {
    return (EAttribute) typeDeclarationEClass.getEStructuralFeatures().get(0);
  }

  public EReference getType_declaration_Implementz() {
    return (EReference) typeDeclarationEClass.getEStructuralFeatures().get(1);
  }

  public EReference getType_declaration_Members() {
  ...
  public EReference getClazz_Super_class() {
  ...
  public EReference getField_Default_value() {
  ...
  public EReference getPrint_statement_Expression() {
  ...
  public EReference getIf_statement_Then_block() {
    return (EReference) ifStatementEClass.getEStructuralFeatures().get(1);
  }

  public EReference getIf_statement_Else_block() {
    return (EReference) ifStatementEClass.getEStructuralFeatures().get(2);
  }

  public EReference getWhile_statement_Condition() {
    return (EReference) whileStatementEClass.getEStructuralFeatures().get(0);
  }

  public EReference getWhile_statement_Block() {
    return (EReference) whileStatementEClass.getEStructuralFeatures().get(1);
  }

  public EReference getFor_statement_Declaration() {
    return (EReference) forStatementEClass.getEStructuralFeatures().get(0);
  }

  public EReference getFor_statement_Condition() {
    return (EReference) forStatementEClass.getEStructuralFeatures().get(1);
  }

  public EReference getFor_statement_Progression() {
    return (EReference) forStatementEClass.getEStructuralFeatures().get(2);
  }

  public EReference getFor_statement_Block() {
    return (EReference) forStatementEClass.getEStructuralFeatures().get(3);
  }

  public EReference getClass_ref_Referenced_class() {
    return (EReference) classRefEClass.getEStructuralFeatures().get(0);
  }

  public EAttribute getNamed_element_Name() {
    return (EAttribute) namedElementEClass.getEStructuralFeatures().get(0);
  }

  public EReference getTyped_declaration_Type_ref() {
  ...
  public EReference getArray_type_ref_Type_ref() {
  ...
  public EReference getContext_Parent_context() {
    return (EReference) contextEClass.getEStructuralFeatures().get(1);
  }

  public EReference getContext_Child_context() {
  ...
  public EReference getSymbol_binding_Value() {
    return (EReference) symbolBindingEClass.getEStructuralFeatures().get(0);
  }

  public EReference getSymbol_binding_Symbol() {
    return (EReference) symbolBindingEClass.getEStructuralFeatures().get(1);
  }

  public EReference getField_binding_Field() {
    return (EReference) fieldBindingEClass.getEStructuralFeatures().get(0);
  }

  public EReference getField_binding_Value() {
    return (EReference) fieldBindingEClass.getEStructuralFeatures().get(1);
  }

  public EAttribute getString_value_Value() {
    return (EAttribute) stringValueEClass.getEStructuralFeatures().get(0);
  }

  public EAttribute getBoolean_value_Value() {
    return (EAttribute) booleanValueEClass.getEStructuralFeatures().get(0);
  }

  public EAttribute getOutput_stream_Stream() {
    return (EAttribute) outputStreamEClass.getEStructuralFeatures().get(0);
  }

  public EReference getState_Root_frame() {
    return (EReference) stateEClass.getEStructuralFeatures().get(0);
  }

  public EReference getState_Objects_heap() {
    return (EReference) stateEClass.getEStructuralFeatures().get(1);
  }

  public EReference getState_Output_stream() {
    return (EReference) stateEClass.getEStructuralFeatures().get(2);
  }

  public EReference getState_Arrays_heap() {
    return (EReference) stateEClass.getEStructuralFeatures().get(3);
  }

  public EReference getState_Context_cache() {
    return (EReference) stateEClass.getEStructuralFeatures().get(4);
  }

  public EReference getState_Frame_cache() {
