...
public class FSMImpl extends MinimalEObjectImpl.Container implements FSM {
	...
	/**
	 * The default value of the '{@link #getCurrentEvent() <em>Current Event</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @see #getCurrentEvent()
	 * @generated
	...
	/**
	 * The cached value of the '{@link #getCurrentEvent() <em>Current Event</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @see #getCurrentEvent()
	 * @generated
		...
		if (currentState != null && currentState.eIsProxy()) {
			...
			if (currentState != oldCurrentState) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, MinifsmPackage.FSM__CURRENT_STATE, oldCurrentState, currentState));
			}
		}
		return currentState;
	}
	...
	public void setCurrentEvent(String newCurrentEvent) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, MinifsmPackage.FSM__CURRENT_EVENT, oldCurrentEvent, currentEvent));
	}
