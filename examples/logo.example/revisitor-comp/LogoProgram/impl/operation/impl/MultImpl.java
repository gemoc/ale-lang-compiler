...
public class MultImpl extends BinaryExpImpl implements Mult {
  ...
  private kmLogo.Mult obj;

  public MultImpl(kmLogo.Mult obj,
  ...
  public double eval(EClassifier turtle) {
    double result;
    result = /*Call org.eclipse.acceleo.query.ast.impl.CallImpl@248dfd53 (serviceName: mult, type: CALLSERVICE)*/;
    return result;
  }
}
