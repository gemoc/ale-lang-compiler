...
public class ArrayAccessOpImpl extends ExpressionOpImpl implements ArrayAccessOp {
  ...
  private ArrayAccess obj;

  public ArrayAccessOpImpl(ArrayAccess obj,
  ...
  public Value evaluateExpression(State state) {
    Value result;
    ArrayRefValue arrayVal = ((ArrayRefValue) (((ArrayRefValue) (rev.$((Expression)this.obj.getObject()).evaluateExpression(((State) (state)))))));
    IntegerValue indexVal = ((IntegerValue) (((IntegerValue) (rev.$((Expression)this.obj.getIndex()).evaluateExpression(((State) (state)))))));
    int v = ((int) (indexVal.getValue()));
    Value vtmp = ((Value) (CollectionService.get(arrayVal.getInstance().getValue(), v)));
    result = ((Value) (rev.$((Value)vtmp).copyj()));
    return result;
  }
}
