...
public class CA5Impl extends MinimalEObjectImpl.Container implements CA5 {
	...
	public Entry<EList<CA5>, EList<CB5>> getMapca0tocb0mapentry() {
		if (eContainerFeatureID() != TestmaprelationsPackage.CA5__MAPCA0TOCB0MAPENTRY)
			return null;
	...
	public void setMapca0tocb0mapentry(Entry<EList<CA5>, EList<CB5>> newMapca0tocb0mapentry) {
		if (newMapca0tocb0mapentry != eInternalContainer() || (eContainerFeatureID() != TestmaprelationsPackage.CA5__MAPCA0TOCB0MAPENTRY && newMapca0tocb0mapentry != null)) {
			...
			if (newMapca0tocb0mapentry != null)
				msgs = ((InternalEObject) newMapca0tocb0mapentry).eInverseAdd(this, TestmaprelationsPackage.MAP_CA5_TO_CB5_MAP_ENTRY__KEY, Entry.class, msgs);
	...
	public NotificationChain eInverseAdd(InternalEObject otherEnd, int featureID,
		...
		switch (featureID) {
			case TestmaprelationsPackage.CA5__MAPCA0TOCB0MAPENTRY :
				if (eInternalContainer() != null)
					msgs = eBasicRemoveFromContainer(msgs);
				return basicSetMapca0tocb0mapentry((Entry<EList<CA5>, EList<CB5>>) otherEnd, msgs);
		}
	...
	public NotificationChain eBasicRemoveFromContainerFeature(NotificationChain msgs) {
		switch (eContainerFeatureID()) {
			case TestmaprelationsPackage.CA5__MAPCA0TOCB0MAPENTRY :
				return eInternalContainer().eInverseRemove(this, TestmaprelationsPackage.MAP_CA5_TO_CB5_MAP_ENTRY__KEY, Entry.class, msgs);
		}
	...
	public Object accept(VisitorInterface visitor) {
		return visitor.visittestmaprelations__CA5(this);
	}
}
