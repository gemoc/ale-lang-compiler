...
public class ConceptB3Impl extends MinimalEObjectImpl.Container implements ConceptB3 {
	...
	public EList<ConceptA3> getConcepta3() {
		if (concepta3 == null) {
			concepta3 = new EObjectWithInverseResolvingEList.ManyInverse<ConceptA3>(
					ConceptA3.class, this, EmfrelationsPackage.CONCEPT_B3__CONCEPTA3,
					EmfrelationsPackage.CONCEPT_A3__CONCEPTB3);
		}
		return concepta3;
	}
	...
	public NotificationChain eInverseAdd(InternalEObject otherEnd, int featureID,
		...
		switch (featureID) {
			case EmfrelationsPackage.CONCEPT_B3__CONCEPTA3 :
				return ((InternalEList<InternalEObject>) (InternalEList<?>) getConcepta3())
