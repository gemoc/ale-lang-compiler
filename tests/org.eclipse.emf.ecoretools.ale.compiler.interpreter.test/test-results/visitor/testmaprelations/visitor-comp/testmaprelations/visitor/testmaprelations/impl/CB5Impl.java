...
public class CB5Impl extends MinimalEObjectImpl.Container implements CB5 {
	...
	public NotificationChain eBasicRemoveFromContainerFeature(NotificationChain msgs) {
		switch (eContainerFeatureID()) {
			case TestmaprelationsPackage.CB5__MAPCA0TOCB0MAPENTRY :
				return eInternalContainer().eInverseRemove(this, TestmaprelationsPackage.MAP_CA5_TO_CB5_MAP_ENTRY__VALUE, Entry.class, msgs);
		}
	...
	public Object accept(VisitorInterface visitor) {
		return visitor.visittestmaprelations__CB5(this);
	}
}
