...
public class CosOpImpl extends UnaryExpressionOpImpl implements CosOp {
  ...
  public double eval(Turtle turtle) {
    double result;
    result = TrigoServices.cosinus(rev.$((Expression)this.obj.getExpression()).eval(((Turtle) (turtle))));
    return result;
  }
}
