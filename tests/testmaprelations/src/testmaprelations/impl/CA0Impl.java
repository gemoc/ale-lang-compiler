...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>CA0</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * </p>
 * <ul>
 *   <li>{@link testmaprelations.impl.CA0Impl#getMapca0tocb0mapentry <em>Mapca0tocb0mapentry</em>}</li>
 * </ul>
 *
 * @generated
 */
	...
	public void setMapca0tocb0mapentry(Map.Entry<CA0, CB0> newMapca0tocb0mapentry) {
		if (newMapca0tocb0mapentry != mapca0tocb0mapentry) {
			...
			if (mapca0tocb0mapentry != null)
				msgs = ((InternalEObject)mapca0tocb0mapentry).eInverseRemove(this, TestmaprelationsPackage.MAP_CA0_TO_CB0_MAP_ENTRY__KEY, Map.Entry.class, msgs);
			if (newMapca0tocb0mapentry != null)
				msgs = ((InternalEObject)newMapca0tocb0mapentry).eInverseAdd(this, TestmaprelationsPackage.MAP_CA0_TO_CB0_MAP_ENTRY__KEY, Map.Entry.class, msgs);
