...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>CB1</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * </p>
 * <ul>
 *   <li>{@link testmaprelations.impl.CB1Impl#getMapca0tocb0mapentry <em>Mapca0tocb0mapentry</em>}</li>
 * </ul>
 *
 * @generated
 */
	...
	public void setMapca0tocb0mapentry(Map.Entry<EList<CA1>, EList<CB1>> newMapca0tocb0mapentry) {
		if (newMapca0tocb0mapentry != mapca0tocb0mapentry) {
			...
			if (mapca0tocb0mapentry != null)
				msgs = ((InternalEObject)mapca0tocb0mapentry).eInverseRemove(this, TestmaprelationsPackage.MAP_CA1_TO_CB1_MAP_ENTRY__VALUE, Map.Entry.class, msgs);
			if (newMapca0tocb0mapentry != null)
				msgs = ((InternalEObject)newMapca0tocb0mapentry).eInverseAdd(this, TestmaprelationsPackage.MAP_CA1_TO_CB1_MAP_ENTRY__VALUE, Map.Entry.class, msgs);
