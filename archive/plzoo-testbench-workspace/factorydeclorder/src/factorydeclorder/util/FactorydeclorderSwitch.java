 ...
 * @generated
 */
public class FactorydeclorderSwitch<T> extends Switch<T> {
	/**
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			...
			case FactorydeclorderPackage.A: {
				A a = (A)theEObject;
				T result = caseA(a);
				if (result == null) result = caseD(a);
				if (result == null) result = caseB(a);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
