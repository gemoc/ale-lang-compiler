...
public class MapCA4ToCB4MapEntryImpl extends MinimalEObjectImpl.Container implements BasicEMap.Entry<CA4, CB4> {
	...
	public void setTypedKey(CA4 newKey) {
		if (newKey != key) {
			...
			if (key != null)
				msgs = ((InternalEObject) key).eInverseRemove(this, TestmaprelationsPackage.CA4__MAPCA0TOCB0MAPENTRY, CA4.class, msgs); // B
			if (newKey != null)
	...
	public void setTypedValue(CB4 newValue) {
		if (newValue != value) {
			NotificationChain msgs = null;
			if (value != null)
				msgs = ((InternalEObject) value).eInverseRemove(this, TestmaprelationsPackage.CB4__MAPCA0TOCB0MAPENTRY, CB4.class, msgs); // B
			if (newValue != null)
