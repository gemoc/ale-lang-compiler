...
public class CB0Impl extends MinimalEObjectImpl.Container implements CB0 {
	...
	public void setMapca0tocb0mapentry(Entry<CA0, CB0> newMapca0tocb0mapentry) {
		if (newMapca0tocb0mapentry != mapca0tocb0mapentry) {
			...
			if (mapca0tocb0mapentry != null)
				msgs = ((InternalEObject) mapca0tocb0mapentry).eInverseRemove(this, TestmaprelationsPackage.MAP_CA0_TO_CB0_MAP_ENTRY__VALUE, Entry.class, msgs); // A
			if (newMapca0tocb0mapentry != null)
				msgs = ((InternalEObject) newMapca0tocb0mapentry).eInverseAdd(this, TestmaprelationsPackage.MAP_CA0_TO_CB0_MAP_ENTRY__VALUE, Entry.class, msgs);
	...
	public NotificationChain eInverseAdd(InternalEObject otherEnd, int featureID,
		...
		switch (featureID) {
			case TestmaprelationsPackage.CB0__MAPCA0TOCB0MAPENTRY :
				if (mapca0tocb0mapentry != null)
					msgs = ((InternalEObject) mapca0tocb0mapentry).eInverseRemove(this, TestmaprelationsPackage.MAP_CA0_TO_CB0_MAP_ENTRY__VALUE, Entry.class, msgs); // D
	...
	public Object accept(VisitorInterface visitor) {
		return visitor.visittestmaprelations__CB0(this);
	}
}
