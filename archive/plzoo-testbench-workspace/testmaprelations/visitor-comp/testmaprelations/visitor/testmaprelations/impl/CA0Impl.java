	...
	public void setMapca0tocb0mapentry(Entry<CA0, CB0> newMapca0tocb0mapentry) {
		if (newMapca0tocb0mapentry != mapca0tocb0mapentry) {
			...
			if (mapca0tocb0mapentry != null)
				msgs = ((InternalEObject) mapca0tocb0mapentry).eInverseRemove(this, TestmaprelationsPackage.MAP_CA0_TO_CB0_MAP_ENTRY__KEY, Entry.class, msgs); // A
	...
	public NotificationChain eInverseAdd(InternalEObject otherEnd, int featureID,
		...
		switch (featureID) {
			case TestmaprelationsPackage.CA0__MAPCA0TOCB0MAPENTRY :
				if (mapca0tocb0mapentry != null)
					msgs = ((InternalEObject) mapca0tocb0mapentry).eInverseRemove(this, TestmaprelationsPackage.MAP_CA0_TO_CB0_MAP_ENTRY__KEY, Entry.class, msgs); // D
