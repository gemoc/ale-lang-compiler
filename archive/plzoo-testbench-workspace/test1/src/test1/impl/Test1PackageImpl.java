...
public class Test1PackageImpl extends EPackageImpl implements Test1Package {
	...
	public void initializePackageContents() {
		...
		initEAttribute(getConceptA_B(), ecorePackage.getELong(), "b", null, 0, 1, ConceptA.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
