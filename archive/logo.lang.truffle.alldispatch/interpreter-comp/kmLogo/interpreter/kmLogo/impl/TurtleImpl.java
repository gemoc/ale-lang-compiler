...
public class TurtleImpl extends MinimalTruffleEObjectImpl.TruffleContainer implements Turtle {
  ...
  @CompilationFinal
  private TurtleDispatchWrapperMove cachedMove;

  @CompilationFinal
  private TurtleDispatchWrapperForward cachedForward;

  @CompilationFinal
  private TurtleDispatchWrapperRotate cachedRotate;

  private TurtleDispatchMove dispatchTurtleMove;

  protected TurtleImpl() {
    super();
    this.cachedMove = new kmLogo.interpreter.kmLogo.impl.TurtleDispatchWrapperMove(this);
    this.cachedForward = new kmLogo.interpreter.kmLogo.impl.TurtleDispatchWrapperForward(this);
    this.cachedRotate = new kmLogo.interpreter.kmLogo.impl.TurtleDispatchWrapperRotate(this);
    this.dispatchTurtleMove = kmLogo.interpreter.kmLogo.impl.TurtleDispatchMoveNodeGen.create(); 
  }
  ...
  public void forward(double steps) {
    dispatchTurtleMove.executeDispatch(this.getCachedMove(), new Object[] {(steps) * (org.eclipse.emf.ecoretools.ale.core.interpreter.services.TrigoServices.cosinus(this.heading)),(steps) * (org.eclipse.emf.ecoretools.ale.core.interpreter.services.TrigoServices.sinus(this.heading))});
        ;
  }
  ...
  public TurtleDispatchWrapperMove getCachedMove() {
    return this.cachedMove;
  }

  public TurtleDispatchWrapperForward getCachedForward() {
    return this.cachedForward;
  }

  public TurtleDispatchWrapperRotate getCachedRotate() {
