 ...
 * </p>
 * <ul>
 *   <li>{@link org.xtext.example.mydsl.myDsl.impl.FileImpl#getCommands <em>Commands</em>}</li>
 * </ul>
 *
 * @generated
 */
public class FileImpl extends MinimalEObjectImpl.Container implements File
{
  ...
  public EList<TopLevelCmd> getCommands()
  {
    if (commands == null)
    {
      commands = new EObjectContainmentEList<TopLevelCmd>(TopLevelCmd.class, this, MyDslPackage.FILE__COMMANDS);
    }
    return commands;
  }
  ...
  public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs)
  {
    switch (featureID)
    {
      case MyDslPackage.FILE__COMMANDS:
