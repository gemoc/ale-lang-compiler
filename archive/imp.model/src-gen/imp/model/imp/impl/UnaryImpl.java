 ...
 * </p>
 * <ul>
 *   <li>{@link imp.model.imp.impl.UnaryImpl#getOp <em>Op</em>}</li>
 *   <li>{@link imp.model.imp.impl.UnaryImpl#getExpr <em>Expr</em>}</li>
 * </ul>
 *
 * @generated
 */
public class UnaryImpl extends ExprImpl implements Unary {
	...
	public NotificationChain basicSetExpr(Expr newExpr, NotificationChain msgs) {
		...
		expr = newExpr;
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, ImpPackage.UNARY__EXPR,
					oldExpr, newExpr);
			if (msgs == null)
				msgs = notification;
			else
	...
	public void setExpr(Expr newExpr) {
		if (newExpr != expr) {
			...
			if (expr != null)
				msgs = ((InternalEObject) expr).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - ImpPackage.UNARY__EXPR,
						null, msgs);
			if (newExpr != null)
				msgs = ((InternalEObject) newExpr).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - ImpPackage.UNARY__EXPR,
						null, msgs);
