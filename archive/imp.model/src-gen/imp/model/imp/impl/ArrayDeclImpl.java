 ...
 * </p>
 * <ul>
 *   <li>{@link imp.model.imp.impl.ArrayDeclImpl#getValues <em>Values</em>}</li>
 * </ul>
 *
 * @generated
 */
public class ArrayDeclImpl extends ExprImpl implements ArrayDecl {
	...
	public EList<Expr> getValues() {
		if (values == null) {
			values = new EObjectContainmentEList<Expr>(Expr.class, this, ImpPackage.ARRAY_DECL__VALUES);
		}
		return values;
	}
	...
	public void eSet(int featureID, Object newValue) {
		...
		case ImpPackage.ARRAY_DECL__VALUES:
			getValues().clear();
			getValues().addAll((Collection<? extends Expr>) newValue);
			return;
		}
