...
public class RightImpl extends PrimitiveImpl implements Right {
  ...
  public void setAngle(Expression newAngle) {
    if (newAngle != angle) {
    	...
    	if (angle != null)
    		msgs = ((InternalEObject)angle).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - kmLogo.visitor.kmLogo.KmLogoPackage.RIGHT__ANGLE, null, msgs);
    	if (newAngle != null)
    		msgs = ((InternalEObject)newAngle).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - kmLogo.visitor.kmLogo.KmLogoPackage.RIGHT__ANGLE, null, msgs);
    	msgs = basicSetAngle(newAngle, msgs);
    	if (msgs != null) msgs.dispatch();
    }
    else if (eNotificationRequired())
    	eNotify(new ENotificationImpl(this, Notification.SET, kmLogo.visitor.kmLogo.KmLogoPackage.RIGHT__ANGLE, newAngle, newAngle));
  }
  ...
  public NotificationChain basicSetAngle(Expression newAngle, NotificationChain msgs) {
    ...
    if (eNotificationRequired()) {
    	ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, kmLogo.visitor.kmLogo.KmLogoPackage.RIGHT__ANGLE, oldAngle, newAngle);
  ...
  public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID,
    ...
    switch(featureID) {
    case kmLogo.visitor.kmLogo.KmLogoPackage.RIGHT__ANGLE:
