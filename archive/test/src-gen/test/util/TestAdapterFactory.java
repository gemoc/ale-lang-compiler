...
public class TestAdapterFactory extends AdapterFactoryImpl {
	...
	protected TestSwitch<Adapter> modelSwitch = new TestSwitch<Adapter>() {
		@Override
		public Adapter caseYolo(Yolo object) {
			return createYoloAdapter();
		}
	...
	/**
	 * Creates a new adapter for an object of class '{@link test.Yolo <em>Yolo</em>}'.
	 * <!-- begin-user-doc -->
	 ...
	 * @generated
	 */
	public Adapter createYoloAdapter() {
		return null;
	}
